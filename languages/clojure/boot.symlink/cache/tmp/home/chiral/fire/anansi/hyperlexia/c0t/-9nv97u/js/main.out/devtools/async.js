...
var o__12849__auto___15702 = (function (){var o__12849__auto__ = (function (){var o__12849__auto__ = Promise;
return goog.object.get(o__12849__auto__,"resolve").call(o__12849__auto__);
})();
return goog.object.get(o__12849__auto__,"then").call(o__12849__auto__,callback);
})();
goog.object.get(o__12849__auto___15702,"catch").call(o__12849__auto___15702,devtools.async.rethrow_outside_promise);
...
var G__15707_15711 = Error;
var target__12871__auto___15712 = G__15707_15711;
if(cljs.core.truth_(target__12871__auto___15712)){
} else {
throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str([cljs.core.str("unable to locate object path "),cljs.core.str(null),cljs.core.str(" in "),cljs.core.str(G__15707_15711)].join('')),cljs.core.str("\n"),cljs.core.str("target__12871__auto__")].join('')));
}

goog.object.set(target__12871__auto___15712,cljs.core.last.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["stackTraceLimit"], null)),Infinity);
