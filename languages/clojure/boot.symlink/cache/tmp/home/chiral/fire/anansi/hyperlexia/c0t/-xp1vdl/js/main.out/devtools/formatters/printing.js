...
var len__8835__auto___15439 = arguments.length;
var i__8836__auto___15440 = (0);
while(true){
if((i__8836__auto___15440 < len__8835__auto___15439)){
args__8842__auto__.push((arguments[i__8836__auto___15440]));

var G__15441 = (i__8836__auto___15440 + (1));
i__8836__auto___15440 = G__15441;
continue;
} else {
}
break;
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__8843__auto__);
});
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq15436){
var G__15437 = cljs.core.first.call(null,seq15436);
var seq15436__$1 = cljs.core.next.call(null,seq15436);
var G__15438 = cljs.core.first.call(null,seq15436__$1);
var seq15436__$2 = cljs.core.next.call(null,seq15436__$1);
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__15437,G__15438,seq15436__$2);
});
...
if(cljs.core.truth_((function (){var or__7619__auto__ = devtools.formatters.helpers.directly_printable_QMARK_.call(null,value);
...
devtools.formatters.printing.TemplateWriter.cljs$lang$ctorPrWriter = (function (this__8271__auto__,writer__8272__auto__,opt__8273__auto__){
return cljs.core._write.call(null,writer__8272__auto__,"devtools.formatters.printing/TemplateWriter");
});
...
var temp__6745__auto__ = cljs.core.first.call(null,cljs.core.first.call(null,group));
if(cljs.core.truth_(temp__6745__auto__)){
var tag = temp__6745__auto__;
...
if(cljs.core.truth_((function (){var and__7607__auto__ = cljs.core.not.call(null,devtools.formatters.printing.already_reference_QMARK_.call(null,group));
if(and__7607__auto__){
var or__7619__auto__ = devtools.formatters.helpers.expandable_QMARK_.call(null,obj);
if(cljs.core.truth_(or__7619__auto__)){
return or__7619__auto__;
} else {
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__15464_SHARP_){
return cljs.core.some_QMARK_.call(null,cljs.core.meta.call(null,p1__15464_SHARP_));
})))){
...
var map__15497 = opts;
var map__15497__$1 = ((((!((map__15497 == null)))?((((map__15497.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__15497.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__15497):map__15497);
var markup_db = cljs.core.get.call(null,map__15497__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
if(cljs.core.truth_((function (){var or__7619__auto__ = (function (){try{if(!((obj == null))){
...
}catch (e15504){var e__12877__auto__ = e15504;
return false;
}})();
if(cljs.core.truth_(or__7619__auto__)){
return or__7619__auto__;
...
}catch (e15506){var e__12877__auto__ = e15506;
return false;
}}
})())){
...
var temp__6745__auto__ = devtools.formatters.printing.build_markup.call(null,markup_db,new cljs.core.Keyword(null,"atomic","atomic",-120459460),obj);
if(cljs.core.truth_(temp__6745__auto__)){
var atomic_markup = temp__6745__auto__;
...
var _STAR_current_state_STAR_15524 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__15526 = opts;
...
var markup_db = cljs.core.get.call(null,map__15526__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_15524;
}});
...
;
var temp__6745__auto___15551 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__6745__auto___15551)){
var managed_print_level_15552 = temp__6745__auto___15551;
var _STAR_print_level_STAR_15550_15553 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_15552;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_15550_15553,managed_print_level_15552,temp__6745__auto___15551,writer,opts,job_fn){
return (function (p1__15546_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__15546_SHARP_,null);
});})(_STAR_print_level_STAR_15550_15553,managed_print_level_15552,temp__6745__auto___15551,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_15550_15553;
}} else {
job_fn.call(null);
}
