...
return (function (p__13321){
var vec__13322 = p__13321;
var attr = cljs.core.nth.call(null,vec__13322,(0),null);
var v = cljs.core.nth.call(null,vec__13322,(1),null);
...
var args13325 = [];
var len__7823__auto___13328 = arguments.length;
var i__7824__auto___13329 = (0);
while(true){
if((i__7824__auto___13329 < len__7823__auto___13328)){
args13325.push((arguments[i__7824__auto___13329]));

var G__13330 = (i__7824__auto___13329 + (1));
i__7824__auto___13329 = G__13330;
continue;
} else {
}
break;
...
var len__7823__auto___13333 = arguments.length;
var i__7824__auto___13334 = (0);
while(true){
if((i__7824__auto___13334 < len__7823__auto___13333)){
args__7830__auto__.push((arguments[i__7824__auto___13334]));

var G__13335 = (i__7824__auto___13334 + (1));
i__7824__auto___13334 = G__13335;
continue;
} else {
}
break;
...
return adzerk.boot_reload.display.style.cljs$core$IFn$_invoke$arity$variadic(argseq__7831__auto__);
});
...
adzerk.boot_reload.display.style.cljs$lang$applyTo = (function (seq13332){
return adzerk.boot_reload.display.style.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq13332));
});
...
adzerk.boot_reload.display.exception_node = (function adzerk$boot_reload$display$exception_node(p__13336){
var map__13340 = p__13336;
var map__13340__$1 = ((((!((map__13340 == null)))?((((map__13340.cljs$lang$protocol_mask$partition0$ & (64))) || (map__13340.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__13340):map__13340);
var data = map__13340__$1;
var message = cljs.core.get.call(null,map__13340__$1,new cljs.core.Keyword(null,"message","message",-406056002));
var line = cljs.core.get.call(null,map__13340__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.call(null,map__13340__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var G__13342 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),null,message);
goog.events.listen(G__13342,goog.events.EventType.CLICK,((function (G__13342,map__13340,map__13340__$1,data,message,line,file){
return (function (){
return adzerk.boot_reload.display.open_file.call(null,data);
});})(G__13342,map__13340,map__13340__$1,data,message,line,file))
);

return G__13342;
});
adzerk.boot_reload.display.warning_node = (function adzerk$boot_reload$display$warning_node(p__13343){
var map__13347 = p__13343;
var map__13347__$1 = ((((!((map__13347 == null)))?((((map__13347.cljs$lang$protocol_mask$partition0$ & (64))) || (map__13347.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__13347):map__13347);
var data = map__13347__$1;
var message = cljs.core.get.call(null,map__13347__$1,new cljs.core.Keyword(null,"message","message",-406056002));
var line = cljs.core.get.call(null,map__13347__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.call(null,map__13347__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var G__13349 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),null,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"span","span",1394872991),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"mr10","mr10",-144509621)),message),adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"span","span",1394872991),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"mr10","mr10",-144509621)),[cljs.core.str("at line "),cljs.core.str(line)].join('')),adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"span","span",1394872991),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"mr10","mr10",-144509621)),file)], null));
goog.events.listen(G__13349,goog.events.EventType.CLICK,((function (G__13349,map__13347,map__13347__$1,data,message,line,file){
return (function (){
return adzerk.boot_reload.display.open_file.call(null,data);
});})(G__13349,map__13347,map__13347__$1,data,message,line,file))
);
...
if(typeof goog.dom.constHtmlToNode !== 'undefined'){
return goog.dom.constHtmlToNode(goog.string.Const.from(logo));
} else {
return goog.dom.htmlToDocumentFragment(logo);
}
});
...
adzerk.boot_reload.display.construct_hud_node = (function adzerk$boot_reload$display$construct_hud_node(p__13350){
var map__13354 = p__13350;
var map__13354__$1 = ((((!((map__13354 == null)))?((((map__13354.cljs$lang$protocol_mask$partition0$ & (64))) || (map__13354.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__13354):map__13354);
var messages = map__13354__$1;
var warnings = cljs.core.get.call(null,map__13354__$1,new cljs.core.Keyword(null,"warnings","warnings",-735437651));
var exception = cljs.core.get.call(null,map__13354__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
var G__13356 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"pad","pad",-36734541),new cljs.core.Keyword(null,"flex","flex",-1425124628),new cljs.core.Keyword(null,"flex-c","flex-c",1898731114),(cljs.core.truth_(exception)?new cljs.core.Keyword(null,"bg-red","bg-red",-1645498040):((cljs.core.seq.call(null,warnings))?new cljs.core.Keyword(null,"bg-yellow","bg-yellow",-1293468429):new cljs.core.Keyword(null,"bg-clear","bg-clear",-673074101)
))));
goog.dom.append(G__13356,adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"logo","logo",1237980263),new cljs.core.Keyword(null,"mr10","mr10",-144509621)),adzerk.boot_reload.display.logo_node.call(null,adzerk.boot_reload.display.cljs_logo)));

goog.dom.append(G__13356,(cljs.core.truth_(exception)?adzerk.boot_reload.display.exception_node.call(null,exception):((cljs.core.seq.call(null,warnings))?adzerk.boot_reload.display.warnings_node.call(null,warnings):adzerk.boot_reload.display.reloaded_node.call(null)
)));
...
adzerk.boot_reload.display.insert_container_BANG_ = (function adzerk$boot_reload$display$insert_container_BANG_(id,p__13357){
var map__13360 = p__13357;
var map__13360__$1 = ((((!((map__13360 == null)))?((((map__13360.cljs$lang$protocol_mask$partition0$ & (64))) || (map__13360.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__13360):map__13360);
var messages = map__13360__$1;
var warnings = cljs.core.get.call(null,map__13360__$1,new cljs.core.Keyword(null,"warnings","warnings",-735437651));
var exception = cljs.core.get.call(null,map__13360__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
...
var show_BANG_ = ((function (hud,el,map__13360,map__13360__$1,messages,warnings,exception){
return (function (){
...
});})(hud,el,map__13360,map__13360__$1,messages,warnings,exception))
;
var no_prob_QMARK_ = (cljs.core.not.call(null,exception)) && (cljs.core.not.call(null,cljs.core.seq.call(null,warnings)));
var hide_BANG_ = ((function (hud,el,show_BANG_,no_prob_QMARK_,map__13360,map__13360__$1,messages,warnings,exception){
return (function (){
...
});})(hud,el,show_BANG_,no_prob_QMARK_,map__13360,map__13360__$1,messages,warnings,exception))
;
...
}catch (e13363){if((e13363 instanceof Error)){
var __13364 = e13363;
} else {
throw e13363;
