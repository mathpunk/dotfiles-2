...
var args16094 = [];
var len__8835__auto___16102 = arguments.length;
var i__8836__auto___16103 = (0);
while(true){
if((i__8836__auto___16103 < len__8835__auto___16102)){
args16094.push((arguments[i__8836__auto___16103]));

var G__16104 = (i__8836__auto___16103 + (1));
i__8836__auto___16103 = G__16104;
continue;
} else {
}
break;
...
if(typeof devtools.toolbox.t_devtools$toolbox16099 !== 'undefined'){
} else {
...
*/
devtools.toolbox.t_devtools$toolbox16099 = (function (obj,header,style,tag,meta16100){
this.obj = obj;
this.header = header;
this.style = style;
this.tag = tag;
...
devtools.toolbox.t_devtools$toolbox16099.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_16101,meta16100__$1){
var self__ = this;
var _16101__$1 = this;
return (new devtools.toolbox.t_devtools$toolbox16099(self__.obj,self__.header,self__.style,self__.tag,meta16100__$1));
});

devtools.toolbox.t_devtools$toolbox16099.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_16101){
var self__ = this;
var _16101__$1 = this;
return self__.meta16100;
});

devtools.toolbox.t_devtools$toolbox16099.prototype.devtools$protocols$IFormat$ = cljs.core.PROTOCOL_SENTINEL;

devtools.toolbox.t_devtools$toolbox16099.prototype.devtools$protocols$IFormat$_header$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
devtools.toolbox.t_devtools$toolbox16099.prototype.devtools$protocols$IFormat$_has_body$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
return true;
});

devtools.toolbox.t_devtools$toolbox16099.prototype.devtools$protocols$IFormat$_body$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
devtools.toolbox.t_devtools$toolbox16099.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"obj","obj",-1672671807,null),new cljs.core.Symbol(null,"header","header",1759972661,null),new cljs.core.Symbol(null,"style","style",1143888791,null),new cljs.core.Symbol(null,"tag","tag",350170304,null),new cljs.core.Symbol(null,"meta16100","meta16100",-94257681,null)], null);
});

devtools.toolbox.t_devtools$toolbox16099.cljs$lang$type = true;

devtools.toolbox.t_devtools$toolbox16099.cljs$lang$ctorStr = "devtools.toolbox/t_devtools$toolbox16099";

devtools.toolbox.t_devtools$toolbox16099.cljs$lang$ctorPrWriter = (function (this__8271__auto__,writer__8272__auto__,opt__8273__auto__){
return cljs.core._write.call(null,writer__8272__auto__,"devtools.toolbox/t_devtools$toolbox16099");
});

devtools.toolbox.__GT_t_devtools$toolbox16099 = (function devtools$toolbox$__GT_t_devtools$toolbox16099(obj__$1,header__$1,style__$1,tag__$1,meta16100){
return (new devtools.toolbox.t_devtools$toolbox16099(obj__$1,header__$1,style__$1,tag__$1,meta16100));
});

}

return (new devtools.toolbox.t_devtools$toolbox16099(obj,header,style,tag,cljs.core.PersistentArrayMap.EMPTY));
});
