...
var len__8701__auto___13052 = arguments.length;
var i__8702__auto___13053 = (0);
while(true){
if((i__8702__auto___13053 < len__8701__auto___13052)){
args__8708__auto__.push((arguments[i__8702__auto___13053]));

var G__13054 = (i__8702__auto___13053 + (1));
i__8702__auto___13053 = G__13054;
continue;
} else {
}
break;
...
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__8709__auto__);
});
...
devtools.formatters.state.update_current_state_BANG_.cljs$lang$applyTo = (function (seq13050){
var G__13051 = cljs.core.first.call(null,seq13050);
var seq13050__$1 = cljs.core.next.call(null,seq13050);
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__13051,seq13050__$1);
});
...
return (p1__13057_SHARP_ === object);
});})(history))
,history);
});
