...
var len__7823__auto___10402 = arguments.length;
var i__7824__auto___10403 = (0);
while(true){
if((i__7824__auto___10403 < len__7823__auto___10402)){
args__7830__auto__.push((arguments[i__7824__auto___10403]));

var G__10404 = (i__7824__auto___10403 + (1));
i__7824__auto___10403 = G__10404;
continue;
} else {
}
break;
...
weasel.repl.repl_print.cljs$lang$applyTo = (function (seq10401){
return weasel.repl.repl_print.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq10401));
});

weasel.repl.console_print = (function weasel$repl$console_print(var_args){
var args__7830__auto__ = [];
var len__7823__auto___10406 = arguments.length;
var i__7824__auto___10407 = (0);
while(true){
if((i__7824__auto___10407 < len__7823__auto___10406)){
args__7830__auto__.push((arguments[i__7824__auto___10407]));

var G__10408 = (i__7824__auto___10407 + (1));
i__7824__auto___10407 = G__10408;
continue;
} else {
}
break;
...
weasel.repl.console_print.cljs$lang$applyTo = (function (seq10405){
return weasel.repl.console_print.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq10405));
});
...
var args__7830__auto__ = [];
var len__7823__auto___10419 = arguments.length;
var i__7824__auto___10420 = (0);
while(true){
if((i__7824__auto___10420 < len__7823__auto___10419)){
args__7830__auto__.push((arguments[i__7824__auto___10420]));

var G__10421 = (i__7824__auto___10420 + (1));
i__7824__auto___10420 = G__10421;
continue;
} else {
}
break;
...
weasel.repl.connect.cljs$core$IFn$_invoke$arity$variadic = (function (repl_server_url,p__10414){
var map__10415 = p__10414;
var map__10415__$1 = ((((!((map__10415 == null)))?((((map__10415.cljs$lang$protocol_mask$partition0$ & (64))) || (map__10415.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__10415):map__10415);
var verbose = cljs.core.get.call(null,map__10415__$1,new cljs.core.Keyword(null,"verbose","verbose",1694226060),true);
var on_open = cljs.core.get.call(null,map__10415__$1,new cljs.core.Keyword(null,"on-open","on-open",-1391088163));
var on_error = cljs.core.get.call(null,map__10415__$1,new cljs.core.Keyword(null,"on-error","on-error",1728533530));
var on_close = cljs.core.get.call(null,map__10415__$1,new cljs.core.Keyword(null,"on-close","on-close",-761178394));
var print = cljs.core.get.call(null,map__10415__$1,new cljs.core.Keyword(null,"print","print",1299562414),new cljs.core.Keyword(null,"repl","repl",-35398667));
var repl_connection = weasel.impls.websocket.websocket_connection.call(null);
cljs.core.swap_BANG_.call(null,weasel.repl.ws_connection,cljs.core.constantly.call(null,repl_connection));

clojure.browser.event.listen.call(null,repl_connection,new cljs.core.Keyword(null,"opened","opened",-1451743091),((function (repl_connection,map__10415,map__10415__$1,verbose,on_open,on_error,on_close,print){
return (function (evt){
...
});})(repl_connection,map__10415,map__10415__$1,verbose,on_open,on_error,on_close,print))
);

clojure.browser.event.listen.call(null,repl_connection,new cljs.core.Keyword(null,"message","message",-406056002),((function (repl_connection,map__10415,map__10415__$1,verbose,on_open,on_error,on_close,print){
return (function (evt){
var map__10417 = cljs.reader.read_string.call(null,evt.message);
var map__10417__$1 = ((((!((map__10417 == null)))?((((map__10417.cljs$lang$protocol_mask$partition0$ & (64))) || (map__10417.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__10417):map__10417);
var message = map__10417__$1;
var op = cljs.core.get.call(null,map__10417__$1,new cljs.core.Keyword(null,"op","op",-1882987955));
var response = cljs.core.pr_str.call(null,weasel.repl.process_message.call(null,message));
return clojure.browser.net.transmit.call(null,repl_connection,response);
});})(repl_connection,map__10415,map__10415__$1,verbose,on_open,on_error,on_close,print))
);

clojure.browser.event.listen.call(null,repl_connection,new cljs.core.Keyword(null,"closed","closed",-919675359),((function (repl_connection,map__10415,map__10415__$1,verbose,on_open,on_error,on_close,print){
return (function (evt){
...
clojure.browser.event.listen.call(null,repl_connection,new cljs.core.Keyword(null,"error","error",-978969032),((function (repl_connection,map__10415,map__10415__$1,verbose,on_open,on_error,on_close,print){
return (function (evt){
if(cljs.core.truth_(verbose)){
...
weasel.repl.connect.cljs$lang$applyTo = (function (seq10412){
var G__10413 = cljs.core.first.call(null,seq10412);
var seq10412__$1 = cljs.core.next.call(null,seq10412);
return weasel.repl.connect.cljs$core$IFn$_invoke$arity$variadic(G__10413,seq10412__$1);
});
