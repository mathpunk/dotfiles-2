...
var reader = (function (){var or__6748__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"file-reader","file-reader",-450847664));
...
var min_length = (function (){var or__6748__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"sanity-hint-min-length","sanity-hint-min-length",104958154));
if(cljs.core.truth_(or__6748__auto__)){
return or__6748__auto__;
} else {
return (128);
...
var file = cljs.core.get.call(null,map__21770__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__21770__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__21770__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e21769){var _e = e21769;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__4655__auto___21772 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__4655__auto___21772)){
var seen_errors_21773 = temp__4655__auto___21772;
if(cljs.core.truth_(seen_errors_21773.has(self))){
} else {
seen_errors_21773.add(self);

var temp__4657__auto___21774 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__4657__auto___21774)){
var sense_21775 = temp__4657__auto___21774;
self.message = [cljs.core.str(self.message),cljs.core.str(", a sanity hint:\n"),cljs.core.str(sense_21775)].join('');
} else {
}
}
} else {
