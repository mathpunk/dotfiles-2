...
cljs.core._add_method.call(null,adzerk.boot_reload.client.handle,new cljs.core.Keyword(null,"reload","reload",863702807),(function (p__16715,opts){
...
var files = cljs.core.get.call(null,map__16716__$1,new cljs.core.Keyword(null,"files","files",-472457450));
...
var len__7823__auto___16724 = arguments.length;
var i__7824__auto___16725 = (0);
while(true){
if((i__7824__auto___16725 < len__7823__auto___16724)){
args__7830__auto__.push((arguments[i__7824__auto___16725]));

var G__16726 = (i__7824__auto___16725 + (1));
i__7824__auto___16725 = G__16726;
continue;
} else {
}
break;
...
adzerk.boot_reload.client.connect.cljs$core$IFn$_invoke$arity$variadic = (function (url,p__16720){
var vec__16721 = p__16720;
var opts = cljs.core.nth.call(null,vec__16721,(0),null);
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"opened","opened",-1451743091),((function (conn,vec__16721,opts){
return (function (evt){
...
});})(conn,vec__16721,opts))
);

clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"message","message",-406056002),((function (conn,vec__16721,opts){
return (function (evt){
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"closed","closed",-919675359),((function (conn,vec__16721,opts){
return (function (evt){
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"error","error",-978969032),((function (conn,vec__16721,opts){
return (function (evt){
...
adzerk.boot_reload.client.connect.cljs$lang$applyTo = (function (seq16718){
var G__16719 = cljs.core.first.call(null,seq16718);
var seq16718__$1 = cljs.core.next.call(null,seq16718);
return adzerk.boot_reload.client.connect.cljs$core$IFn$_invoke$arity$variadic(G__16719,seq16718__$1);
});
