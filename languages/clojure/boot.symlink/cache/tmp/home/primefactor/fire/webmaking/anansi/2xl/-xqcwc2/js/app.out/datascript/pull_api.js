...
return cljs.core.assoc.call(null,frame,new cljs.core.Keyword(null,"eids","eids",1546550700),eids,new cljs.core.Keyword(null,"specs","specs",1426570741),cljs.core.seq.call(null,new cljs.core.Keyword(null,"attrs","attrs",-2090668713).cljs$core$IFn$_invoke$arity$1(pattern)),new cljs.core.Keyword(null,"wildcard?","wildcard?",-686044101),new cljs.core.Keyword(null,"wildcard?","wildcard?",-686044101).cljs$core$IFn$_invoke$arity$1(pattern),new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.transient$.call(null,cljs.core.PersistentArrayMap.EMPTY),new cljs.core.Keyword(null,"results","results",-1134170113),(function (){var G__15554 = new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(frame);
if(cljs.core.seq.call(null,kvps)){
return cljs.core.conj_BANG_.call(null,G__15554,kvps);
} else {
return G__15554;
}
})());
...
var depth = cljs.core.get.call(null,map__15557__$1,new cljs.core.Keyword(null,"depth","depth",1768663640));
var seen = cljs.core.get.call(null,map__15557__$1,new cljs.core.Keyword(null,"seen","seen",-518999789));
...
var G__15560 = new cljs.core.Keyword(null,"kvps","kvps",65308317).cljs$core$IFn$_invoke$arity$1(frame);
var G__15560__$1 = (((G__15560 == null))?null:cljs.core.persistent_BANG_.call(null,G__15560));
if((G__15560__$1 == null)){
return null;
} else {
return cljs.core.get.call(null,G__15560__$1,key);
}
});
...
datascript.pull_api.pull_recursion_frame = (function datascript$pull_api$pull_recursion_frame(db,p__15561){
var vec__15566 = p__15561;
var seq__15567 = cljs.core.seq.call(null,vec__15566);
var first__15568 = cljs.core.first.call(null,seq__15567);
var seq__15567__$1 = cljs.core.next.call(null,seq__15567);
var frame = first__15568;
var frames = seq__15567__$1;
...
var or__6747__auto__ = datascript.pull_api.pull_seen_eid.call(null,frame__$1,frames,eid);
...
var results = (function (){var G__15569 = new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(frame);
if(cljs.core.seq.call(null,kvps)){
return cljs.core.conj_BANG_.call(null,G__15569,kvps);
} else {
return G__15569;
}
})();
...
var map__15572 = parent;
var map__15572__$1 = ((((!((map__15572 == null)))?((((map__15572.cljs$lang$protocol_mask$partition0$ & (64))) || (map__15572.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__15572):map__15572);
var recursion = cljs.core.get.call(null,map__15572__$1,new cljs.core.Keyword(null,"recursion","recursion",-749738765));
var pattern = cljs.core.get.call(null,map__15572__$1,new cljs.core.Keyword(null,"pattern","pattern",242135423));
...
var pattern_15574 = (new datascript.pull_parser.PullSpec(true,cljs.core.PersistentArrayMap.EMPTY,null,null,null));
datascript.pull_api.expand_frame = ((function (pattern_15574){
...
return cljs.core.assoc.call(null,datascript.pull_api.subpattern_frame.call(null,pattern_15574,eids,multi_QMARK_,attr_key),new cljs.core.Keyword(null,"recursion","recursion",-749738765),rec);
});})(pattern_15574))
;
datascript.pull_api.pull_attr_datoms = (function datascript$pull_api$pull_attr_datoms(db,attr_key,attr,eid,forward_QMARK_,datoms,opts,p__15576){
var vec__15584 = p__15576;
var seq__15585 = cljs.core.seq.call(null,vec__15584);
var first__15586 = cljs.core.first.call(null,seq__15585);
var seq__15585__$1 = cljs.core.next.call(null,seq__15585);
var parent = first__15586;
var frames = seq__15585__$1;
...
var found = cljs.core.not_empty.call(null,(function (){var G__15587 = datoms;
if(cljs.core.truth_(limit)){
return cljs.core.into.call(null,cljs.core.PersistentVector.EMPTY,cljs.core.take.call(null,limit),G__15587);
} else {
return G__15587;
}
})());
...
var datom_val = (cljs.core.truth_(forward_QMARK_)?((function (ref_QMARK_,component_QMARK_,multi_QMARK_,limit,found,vec__15584,seq__15585,first__15586,seq__15585__$1,parent,frames){
return (function (d){
return d.v;
});})(ref_QMARK_,component_QMARK_,multi_QMARK_,limit,found,vec__15584,seq__15585,first__15586,seq__15585__$1,parent,frames))
:((function (ref_QMARK_,component_QMARK_,multi_QMARK_,limit,found,vec__15584,seq__15585,first__15586,seq__15585__$1,parent,frames){
return (function (d){
return d.e;
});})(ref_QMARK_,component_QMARK_,multi_QMARK_,limit,found,vec__15584,seq__15585,first__15586,seq__15585__$1,parent,frames))
);
...
if(cljs.core.truth_((function (){var and__6735__auto__ = component_QMARK_;
...
var as_value = (function (){var G__15588 = datom_val;
if(ref_QMARK_){
return cljs.core.comp.call(null,((function (G__15588,ref_QMARK_,component_QMARK_,multi_QMARK_,datom_val,limit,found,vec__15584,seq__15585,first__15586,seq__15585__$1,parent,frames){
return (function (p1__15575_SHARP_){
return cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword("db","id","db/id",-1388397098)],[p1__15575_SHARP_]);
});})(G__15588,ref_QMARK_,component_QMARK_,multi_QMARK_,datom_val,limit,found,vec__15584,seq__15585,first__15586,seq__15585__$1,parent,frames))
,G__15588);
} else {
return G__15588;
}
...
return cljs.core.conj.call(null,frames,cljs.core.update.call(null,parent,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,attr_key,(function (){var G__15589 = cljs.core.into.call(null,cljs.core.PersistentVector.EMPTY,cljs.core.map.call(null,as_value),found);
if(single_QMARK_){
return cljs.core.first.call(null,G__15589);
} else {
return G__15589;
}
})()));
...
return cljs.core.conj.call(null,frames,(function (){var G__15590 = parent;
if(cljs.core.contains_QMARK_.call(null,opts,new cljs.core.Keyword(null,"default","default",-1987822328))){
return cljs.core.update.call(null,G__15590,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,attr_key,new cljs.core.Keyword(null,"default","default",-1987822328).cljs$core$IFn$_invoke$arity$1(opts));
} else {
return G__15590;
}
})());
...
var vec__15594 = spec;
var attr_key = cljs.core.nth.call(null,vec__15594,(0),null);
var opts = cljs.core.nth.call(null,vec__15594,(1),null);
...
datascript.pull_api.filter_reverse_attrs = cljs.core.filter.call(null,(function (p__15597){
...
datascript.pull_api.pull_expand_reverse_frame = (function datascript$pull_api$pull_expand_reverse_frame(db,p__15601){
var vec__15605 = p__15601;
var seq__15606 = cljs.core.seq.call(null,vec__15605);
var first__15607 = cljs.core.first.call(null,seq__15606);
var seq__15606__$1 = cljs.core.next.call(null,seq__15606);
var frame = first__15607;
var frames = seq__15606__$1;
return datascript.pull_api.expand_result.call(null,frames,datascript.pull_api.into_BANG_.call(null,new cljs.core.Keyword(null,"expand-kvps","expand-kvps",44141154).cljs$core$IFn$_invoke$arity$1(frame),(function (){var or__6747__auto__ = datascript.pull_api.single_frame_result.call(null,new cljs.core.Keyword("datascript.pull-api","expand-rev","datascript.pull-api/expand-rev",2143627459),frame);
if(cljs.core.truth_(or__6747__auto__)){
return or__6747__auto__;
} else {
...
datascript.pull_api.pull_expand_frame = (function datascript$pull_api$pull_expand_frame(db,p__15608){
var vec__15615 = p__15608;
var seq__15616 = cljs.core.seq.call(null,vec__15615);
var first__15617 = cljs.core.first.call(null,seq__15616);
var seq__15616__$1 = cljs.core.next.call(null,seq__15616);
var frame = first__15617;
var frames = seq__15616__$1;
...
var vec__15618 = cljs.core.first.call(null,datoms_by_attr);
var attr = cljs.core.nth.call(null,vec__15618,(0),null);
var datoms = cljs.core.nth.call(null,vec__15618,(1),null);
...
var attr = cljs.core.get.call(null,map__15624__$1,new cljs.core.Keyword(null,"attr","attr",-604132353));
var recursion = cljs.core.get.call(null,map__15624__$1,new cljs.core.Keyword(null,"recursion","recursion",-749738765));
var rec = (function (){var G__15626 = recursion;
if(cljs.core.some_QMARK_.call(null,attr)){
return datascript.pull_api.push_recursion.call(null,G__15626,attr,eid);
} else {
return G__15626;
}
})();
...
var map__15629 = frame;
var map__15629__$1 = ((((!((map__15629 == null)))?((((map__15629.cljs$lang$protocol_mask$partition0$ & (64))) || (map__15629.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__15629):map__15629);
var eid = cljs.core.get.call(null,map__15629__$1,new cljs.core.Keyword(null,"eid","eid",559519930));
var pattern = cljs.core.get.call(null,map__15629__$1,new cljs.core.Keyword(null,"pattern","pattern",242135423));
var or__6747__auto__ = datascript.pull_api.pull_seen_eid.call(null,frame,frames,eid);
if(cljs.core.truth_(or__6747__auto__)){
return or__6747__auto__;
} else {
...
datascript.pull_api.pull_pattern_frame = (function datascript$pull_api$pull_pattern_frame(db,p__15631){
while(true){
var vec__15635 = p__15631;
var seq__15636 = cljs.core.seq.call(null,vec__15635);
var first__15637 = cljs.core.first.call(null,seq__15636);
var seq__15636__$1 = cljs.core.next.call(null,seq__15636);
var frame = first__15637;
var frames = seq__15636__$1;
var temp__4655__auto__ = cljs.core.seq.call(null,new cljs.core.Keyword(null,"eids","eids",1546550700).cljs$core$IFn$_invoke$arity$1(frame));
if(temp__4655__auto__){
var eids = temp__4655__auto__;
...
var G__15638 = db;
var G__15639 = cljs.core.conj.call(null,frames,datascript.pull_api.reset_frame.call(null,frame,cljs.core.rest.call(null,eids),cljs.core.not_empty.call(null,cljs.core.persistent_BANG_.call(null,new cljs.core.Keyword(null,"kvps","kvps",65308317).cljs$core$IFn$_invoke$arity$1(frame)))));
db = G__15638;
p__15631 = G__15639;
continue;
}
...
while(true){
var G__15646 = (((new cljs.core.Keyword(null,"state","state",-1988618099).cljs$core$IFn$_invoke$arity$1(cljs.core.first.call(null,frames)) instanceof cljs.core.Keyword))?new cljs.core.Keyword(null,"state","state",-1988618099).cljs$core$IFn$_invoke$arity$1(cljs.core.first.call(null,frames)).fqn:null);
switch (G__15646) {
case "expand":
var G__15653 = db;
var G__15654 = datascript.pull_api.pull_expand_frame.call(null,db,frames);
db = G__15653;
frames = G__15654;
continue;
...
case "expand-rev":
var G__15655 = db;
var G__15656 = datascript.pull_api.pull_expand_reverse_frame.call(null,db,frames);
db = G__15655;
frames = G__15656;
continue;
...
case "pattern":
var G__15657 = db;
var G__15658 = datascript.pull_api.pull_pattern_frame.call(null,db,frames);
db = G__15657;
frames = G__15658;
continue;
...
case "recursion":
var G__15659 = db;
var G__15660 = datascript.pull_api.pull_recursion_frame.call(null,db,frames);
db = G__15659;
frames = G__15660;
continue;
...
break;
case "done":
var vec__15647 = frames;
var seq__15648 = cljs.core.seq.call(null,vec__15647);
var first__15649 = cljs.core.first.call(null,seq__15648);
var seq__15648__$1 = cljs.core.next.call(null,seq__15648);
var f = first__15649;
var remaining = seq__15648__$1;
var result = (function (){var G__15650 = cljs.core.persistent_BANG_.call(null,new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(f));
if(cljs.core.not.call(null,new cljs.core.Keyword(null,"multi?","multi?",-749311069).cljs$core$IFn$_invoke$arity$1(f))){
return cljs.core.first.call(null,G__15650);
} else {
return G__15650;
}
})();
...
var G__15661 = db;
var G__15662 = cljs.core.conj.call(null,cljs.core.rest.call(null,remaining),(function (){var G__15651 = cljs.core.first.call(null,remaining);
if(cljs.core.truth_(result)){
return cljs.core.update.call(null,G__15651,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,new cljs.core.Keyword(null,"attr","attr",-604132353).cljs$core$IFn$_invoke$arity$1(f),result);
} else {
return G__15651;
}
})());
...
var eids__$1 = cljs.core.into.call(null,cljs.core.PersistentVector.EMPTY,cljs.core.map.call(null,(function (p1__15663_SHARP_){
return datascript.db.entid_strict.call(null,db,p1__15663_SHARP_);
})),eids);
return datascript.pull_api.pull_pattern.call(null,db,(function (){var x__7581__auto__ = datascript.pull_api.initial_frame.call(null,pattern,eids__$1,multi_QMARK_);
