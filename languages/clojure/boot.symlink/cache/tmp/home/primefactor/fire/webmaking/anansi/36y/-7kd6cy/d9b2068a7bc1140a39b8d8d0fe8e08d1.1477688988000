...
return (function (p__11351){
var vec__11352 = p__11351;
var attr = cljs.core.nth.call(null,vec__11352,(0),null);
var v = cljs.core.nth.call(null,vec__11352,(1),null);
...
var args11355 = [];
var len__7823__auto___11358 = arguments.length;
var i__7824__auto___11359 = (0);
while(true){
if((i__7824__auto___11359 < len__7823__auto___11358)){
args11355.push((arguments[i__7824__auto___11359]));

var G__11360 = (i__7824__auto___11359 + (1));
i__7824__auto___11359 = G__11360;
continue;
} else {
}
break;
...
var len__7823__auto___11363 = arguments.length;
var i__7824__auto___11364 = (0);
while(true){
if((i__7824__auto___11364 < len__7823__auto___11363)){
args__7830__auto__.push((arguments[i__7824__auto___11364]));

var G__11365 = (i__7824__auto___11364 + (1));
i__7824__auto___11364 = G__11365;
continue;
} else {
}
break;
...
adzerk.boot_reload.display.style.cljs$lang$applyTo = (function (seq11362){
return adzerk.boot_reload.display.style.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq11362));
});
...
adzerk.boot_reload.display.exception_node = (function adzerk$boot_reload$display$exception_node(p__11366){
var map__11370 = p__11366;
var map__11370__$1 = ((((!((map__11370 == null)))?((((map__11370.cljs$lang$protocol_mask$partition0$ & (64))) || (map__11370.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__11370):map__11370);
var data = map__11370__$1;
var message = cljs.core.get.call(null,map__11370__$1,new cljs.core.Keyword(null,"message","message",-406056002));
var line = cljs.core.get.call(null,map__11370__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.call(null,map__11370__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var G__11372 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),null,message);
goog.events.listen(G__11372,goog.events.EventType.CLICK,((function (G__11372,map__11370,map__11370__$1,data,message,line,file){
return (function (){
return adzerk.boot_reload.display.open_file.call(null,data);
});})(G__11372,map__11370,map__11370__$1,data,message,line,file))
);

return G__11372;
});
adzerk.boot_reload.display.warning_node = (function adzerk$boot_reload$display$warning_node(p__11373){
var map__11377 = p__11373;
...
adzerk.boot_reload.display.construct_hud_node = (function adzerk$boot_reload$display$construct_hud_node(p__11380){
var map__11384 = p__11380;
...
var messages = map__11384__$1;
var warnings = cljs.core.get.call(null,map__11384__$1,new cljs.core.Keyword(null,"warnings","warnings",-735437651));
var exception = cljs.core.get.call(null,map__11384__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
var G__11386 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"pad","pad",-36734541),new cljs.core.Keyword(null,"flex","flex",-1425124628),new cljs.core.Keyword(null,"flex-c","flex-c",1898731114),(cljs.core.truth_(exception)?new cljs.core.Keyword(null,"bg-red","bg-red",-1645498040):((cljs.core.seq.call(null,warnings))?new cljs.core.Keyword(null,"bg-yellow","bg-yellow",-1293468429):new cljs.core.Keyword(null,"bg-clear","bg-clear",-673074101)
))));
goog.dom.append(G__11386,adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"logo","logo",1237980263),new cljs.core.Keyword(null,"mr10","mr10",-144509621)),adzerk.boot_reload.display.logo_node.call(null,adzerk.boot_reload.display.cljs_logo)));

goog.dom.append(G__11386,(cljs.core.truth_(exception)?adzerk.boot_reload.display.exception_node.call(null,exception):((cljs.core.seq.call(null,warnings))?adzerk.boot_reload.display.warnings_node.call(null,warnings):adzerk.boot_reload.display.reloaded_node.call(null)
)));
...
adzerk.boot_reload.display.insert_container_BANG_ = (function adzerk$boot_reload$display$insert_container_BANG_(id,p__11387){
...
var messages = map__11390__$1;
var warnings = cljs.core.get.call(null,map__11390__$1,new cljs.core.Keyword(null,"warnings","warnings",-735437651));
var exception = cljs.core.get.call(null,map__11390__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
...
var show_BANG_ = ((function (hud,el,map__11390,map__11390__$1,messages,warnings,exception){
return (function (){
...
});})(hud,el,map__11390,map__11390__$1,messages,warnings,exception))
;
var no_prob_QMARK_ = (cljs.core.not.call(null,exception)) && (cljs.core.not.call(null,cljs.core.seq.call(null,warnings)));
var hide_BANG_ = ((function (hud,el,show_BANG_,no_prob_QMARK_,map__11390,map__11390__$1,messages,warnings,exception){
return (function (){
...
});})(hud,el,show_BANG_,no_prob_QMARK_,map__11390,map__11390__$1,messages,warnings,exception))
;
