...
var o__16888__auto___21743 = (function (){var o__16888__auto__ = (function (){var o__16888__auto__ = Promise;
return goog.object.get(o__16888__auto__,"resolve").call(o__16888__auto__);
})();
return goog.object.get(o__16888__auto__,"then").call(o__16888__auto__,callback);
})();
goog.object.get(o__16888__auto___21743,"catch").call(o__16888__auto___21743,devtools.async.rethrow_outside_promise);
...
var G__21745_21746 = Error;
var target__16907__auto___21747 = G__21745_21746;
if(cljs.core.truth_(target__16907__auto___21747)){
} else {
throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str([cljs.core.str("unable to locate object path "),cljs.core.str(null),cljs.core.str(" in "),cljs.core.str(G__21745_21746)].join('')),cljs.core.str("\n"),cljs.core.str("target__16907__auto__")].join('')));
}

goog.object.set(target__16907__auto___21747,cljs.core.last.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["stackTraceLimit"], null)),Infinity);
