...
var len__8701__auto___14623 = arguments.length;
var i__8702__auto___14625 = (0);
while(true){
if((i__8702__auto___14625 < len__8701__auto___14623)){
args__8708__auto__.push((arguments[i__8702__auto___14625]));

var G__14627 = (i__8702__auto___14625 + (1));
i__8702__auto___14625 = G__14627;
continue;
} else {
}
break;
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__8709__auto__);
});
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq14617){
var G__14618 = cljs.core.first.call(null,seq14617);
var seq14617__$1 = cljs.core.next.call(null,seq14617);
var G__14619 = cljs.core.first.call(null,seq14617__$1);
var seq14617__$2 = cljs.core.next.call(null,seq14617__$1);
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__14618,G__14619,seq14617__$2);
});
...
if(cljs.core.truth_((function (){var or__7485__auto__ = devtools.formatters.helpers.directly_printable_QMARK_.call(null,value);
...
devtools.formatters.printing.TemplateWriter.cljs$lang$ctorPrWriter = (function (this__8137__auto__,writer__8138__auto__,opt__8139__auto__){
return cljs.core._write.call(null,writer__8138__auto__,"devtools.formatters.printing/TemplateWriter");
});
...
if(cljs.core.truth_((function (){var and__7473__auto__ = cljs.core.not.call(null,devtools.formatters.printing.already_reference_QMARK_.call(null,group));
if(and__7473__auto__){
var or__7485__auto__ = devtools.formatters.helpers.expandable_QMARK_.call(null,obj);
if(cljs.core.truth_(or__7485__auto__)){
return or__7485__auto__;
} else {
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__14667_SHARP_){
return cljs.core.some_QMARK_.call(null,cljs.core.meta.call(null,p1__14667_SHARP_));
})))){
...
var markup_db = cljs.core.get.call(null,map__14713__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
if(cljs.core.truth_((function (){var or__7485__auto__ = (function (){try{if(!((obj == null))){
...
}catch (e14719){var e__12298__auto__ = e14719;
return false;
}})();
if(cljs.core.truth_(or__7485__auto__)){
return or__7485__auto__;
...
}catch (e14721){var e__12298__auto__ = e14721;
return false;
}}
})())){
...
var _STAR_current_state_STAR_14736 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__14738 = opts;
var map__14738__$1 = ((((!((map__14738 == null)))?((((map__14738.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__14738.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__14738):map__14738);
var markup_db = cljs.core.get.call(null,map__14738__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_14736;
}});
...
;
var temp__6745__auto___14744 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__6745__auto___14744)){
var managed_print_level_14745 = temp__6745__auto___14744;
var _STAR_print_level_STAR_14743_14746 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_14745;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_14743_14746,managed_print_level_14745,temp__6745__auto___14744,writer,opts,job_fn){
return (function (p1__14741_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__14741_SHARP_,null);
});})(_STAR_print_level_STAR_14743_14746,managed_print_level_14745,temp__6745__auto___14744,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_14743_14746;
}} else {
job_fn.call(null);
}
