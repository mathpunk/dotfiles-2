...
var o__12028__auto___14866 = (function (){var o__12028__auto__ = (function (){var o__12028__auto__ = Promise;
return goog.object.get(o__12028__auto__,"resolve").call(o__12028__auto__);
})();
return goog.object.get(o__12028__auto__,"then").call(o__12028__auto__,callback);
})();
goog.object.get(o__12028__auto___14866,"catch").call(o__12028__auto___14866,devtools.async.rethrow_outside_promise);
...
var G__14880_14881 = Error;
var target__12049__auto___14882 = G__14880_14881;
if(cljs.core.truth_(target__12049__auto___14882)){
} else {
throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str([cljs.core.str("unable to locate object path "),cljs.core.str(null),cljs.core.str(" in "),cljs.core.str(G__14880_14881)].join('')),cljs.core.str("\n"),cljs.core.str("target__12049__auto__")].join('')));
}

goog.object.set(target__12049__auto___14882,cljs.core.last.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["stackTraceLimit"], null)),Infinity);
