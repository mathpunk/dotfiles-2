...
var args15270 = [];
var len__8701__auto___15278 = arguments.length;
var i__8702__auto___15279 = (0);
while(true){
if((i__8702__auto___15279 < len__8701__auto___15278)){
args15270.push((arguments[i__8702__auto___15279]));

var G__15280 = (i__8702__auto___15279 + (1));
i__8702__auto___15279 = G__15280;
continue;
} else {
}
break;
...
if(typeof devtools.toolbox.t_devtools$toolbox15275 !== 'undefined'){
} else {
...
*/
devtools.toolbox.t_devtools$toolbox15275 = (function (obj,header,style,tag,meta15276){
this.obj = obj;
this.header = header;
this.style = style;
this.tag = tag;
...
devtools.toolbox.t_devtools$toolbox15275.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_15277,meta15276__$1){
var self__ = this;
var _15277__$1 = this;
return (new devtools.toolbox.t_devtools$toolbox15275(self__.obj,self__.header,self__.style,self__.tag,meta15276__$1));
});

devtools.toolbox.t_devtools$toolbox15275.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_15277){
var self__ = this;
var _15277__$1 = this;
return self__.meta15276;
});

devtools.toolbox.t_devtools$toolbox15275.prototype.devtools$protocols$IFormat$ = cljs.core.PROTOCOL_SENTINEL;

devtools.toolbox.t_devtools$toolbox15275.prototype.devtools$protocols$IFormat$_header$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
devtools.toolbox.t_devtools$toolbox15275.prototype.devtools$protocols$IFormat$_has_body$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
return true;
});

devtools.toolbox.t_devtools$toolbox15275.prototype.devtools$protocols$IFormat$_body$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
devtools.toolbox.t_devtools$toolbox15275.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"obj","obj",-1672671807,null),new cljs.core.Symbol(null,"header","header",1759972661,null),new cljs.core.Symbol(null,"style","style",1143888791,null),new cljs.core.Symbol(null,"tag","tag",350170304,null),new cljs.core.Symbol(null,"meta15276","meta15276",180996787,null)], null);
});

devtools.toolbox.t_devtools$toolbox15275.cljs$lang$type = true;

devtools.toolbox.t_devtools$toolbox15275.cljs$lang$ctorStr = "devtools.toolbox/t_devtools$toolbox15275";

devtools.toolbox.t_devtools$toolbox15275.cljs$lang$ctorPrWriter = (function (this__8137__auto__,writer__8138__auto__,opt__8139__auto__){
return cljs.core._write.call(null,writer__8138__auto__,"devtools.toolbox/t_devtools$toolbox15275");
});

devtools.toolbox.__GT_t_devtools$toolbox15275 = (function devtools$toolbox$__GT_t_devtools$toolbox15275(obj__$1,header__$1,style__$1,tag__$1,meta15276){
return (new devtools.toolbox.t_devtools$toolbox15275(obj__$1,header__$1,style__$1,tag__$1,meta15276));
});

}

return (new devtools.toolbox.t_devtools$toolbox15275(obj,header,style,tag,cljs.core.PersistentArrayMap.EMPTY));
});
