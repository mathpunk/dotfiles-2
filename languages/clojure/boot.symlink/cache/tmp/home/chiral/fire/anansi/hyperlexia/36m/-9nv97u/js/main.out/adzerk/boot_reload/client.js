...
cljs.core._add_method.call(null,adzerk.boot_reload.client.handle,new cljs.core.Keyword(null,"reload","reload",863702807),(function (p__10034,opts){
...
var files = cljs.core.get.call(null,map__10035__$1,new cljs.core.Keyword(null,"files","files",-472457450));
...
var len__8701__auto___10046 = arguments.length;
var i__8702__auto___10047 = (0);
while(true){
if((i__8702__auto___10047 < len__8701__auto___10046)){
args__8708__auto__.push((arguments[i__8702__auto___10047]));

var G__10048 = (i__8702__auto___10047 + (1));
i__8702__auto___10047 = G__10048;
continue;
} else {
}
break;
...
adzerk.boot_reload.client.connect.cljs$core$IFn$_invoke$arity$variadic = (function (url,p__10041){
var vec__10042 = p__10041;
var opts = cljs.core.nth.call(null,vec__10042,(0),null);
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"opened","opened",-1451743091),((function (conn,vec__10042,opts){
return (function (evt){
...
});})(conn,vec__10042,opts))
);

clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"message","message",-406056002),((function (conn,vec__10042,opts){
return (function (evt){
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"closed","closed",-919675359),((function (conn,vec__10042,opts){
return (function (evt){
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"error","error",-978969032),((function (conn,vec__10042,opts){
return (function (evt){
...
adzerk.boot_reload.client.connect.cljs$lang$applyTo = (function (seq10039){
var G__10040 = cljs.core.first.call(null,seq10039);
var seq10039__$1 = cljs.core.next.call(null,seq10039);
return adzerk.boot_reload.client.connect.cljs$core$IFn$_invoke$arity$variadic(G__10040,seq10039__$1);
});
