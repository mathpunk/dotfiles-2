...
return (function (p__9560){
var vec__9561 = p__9560;
var attr = cljs.core.nth.call(null,vec__9561,(0),null);
var v = cljs.core.nth.call(null,vec__9561,(1),null);
...
var args9565 = [];
var len__8701__auto___9575 = arguments.length;
var i__8702__auto___9576 = (0);
while(true){
if((i__8702__auto___9576 < len__8701__auto___9575)){
args9565.push((arguments[i__8702__auto___9576]));

var G__9577 = (i__8702__auto___9576 + (1));
i__8702__auto___9576 = G__9577;
continue;
} else {
}
break;
...
var len__8701__auto___9580 = arguments.length;
var i__8702__auto___9581 = (0);
while(true){
if((i__8702__auto___9581 < len__8701__auto___9580)){
args__8708__auto__.push((arguments[i__8702__auto___9581]));

var G__9582 = (i__8702__auto___9581 + (1));
i__8702__auto___9581 = G__9582;
continue;
} else {
}
break;
...
return adzerk.boot_reload.display.style.cljs$core$IFn$_invoke$arity$variadic(argseq__8709__auto__);
});
...
adzerk.boot_reload.display.style.cljs$lang$applyTo = (function (seq9579){
return adzerk.boot_reload.display.style.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq9579));
});
...
adzerk.boot_reload.display.exception_node = (function adzerk$boot_reload$display$exception_node(p__9594){
var map__9598 = p__9594;
...
var data = map__9598__$1;
var message = cljs.core.get.call(null,map__9598__$1,new cljs.core.Keyword(null,"message","message",-406056002));
var line = cljs.core.get.call(null,map__9598__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.call(null,map__9598__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var G__9600 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),null,message);
goog.events.listen(G__9600,goog.events.EventType.CLICK,((function (G__9600,map__9598,map__9598__$1,data,message,line,file){
return (function (){
return adzerk.boot_reload.display.open_file.call(null,data);
});})(G__9600,map__9598,map__9598__$1,data,message,line,file))
);

return G__9600;
});
adzerk.boot_reload.display.warning_node = (function adzerk$boot_reload$display$warning_node(p__9602){
var map__9607 = p__9602;
var map__9607__$1 = ((((!((map__9607 == null)))?((((map__9607.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__9607.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__9607):map__9607);
var data = map__9607__$1;
var message = cljs.core.get.call(null,map__9607__$1,new cljs.core.Keyword(null,"message","message",-406056002));
var line = cljs.core.get.call(null,map__9607__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.call(null,map__9607__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var G__9609 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),null,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"span","span",1394872991),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"mr10","mr10",-144509621)),message),adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"span","span",1394872991),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"mr10","mr10",-144509621)),[cljs.core.str("at line "),cljs.core.str(line)].join('')),adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"span","span",1394872991),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"mr10","mr10",-144509621)),file)], null));
goog.events.listen(G__9609,goog.events.EventType.CLICK,((function (G__9609,map__9607,map__9607__$1,data,message,line,file){
return (function (){
return adzerk.boot_reload.display.open_file.call(null,data);
});})(G__9609,map__9607,map__9607__$1,data,message,line,file))
);
...
adzerk.boot_reload.display.construct_hud_node = (function adzerk$boot_reload$display$construct_hud_node(p__9623){
...
var messages = map__9627__$1;
var warnings = cljs.core.get.call(null,map__9627__$1,new cljs.core.Keyword(null,"warnings","warnings",-735437651));
var exception = cljs.core.get.call(null,map__9627__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
var G__9631 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"pad","pad",-36734541),new cljs.core.Keyword(null,"flex","flex",-1425124628),new cljs.core.Keyword(null,"flex-c","flex-c",1898731114),(cljs.core.truth_(exception)?new cljs.core.Keyword(null,"bg-red","bg-red",-1645498040):((cljs.core.seq.call(null,warnings))?new cljs.core.Keyword(null,"bg-yellow","bg-yellow",-1293468429):new cljs.core.Keyword(null,"bg-clear","bg-clear",-673074101)
))));
goog.dom.append(G__9631,adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"logo","logo",1237980263),new cljs.core.Keyword(null,"mr10","mr10",-144509621)),adzerk.boot_reload.display.logo_node.call(null,adzerk.boot_reload.display.cljs_logo)));

goog.dom.append(G__9631,(cljs.core.truth_(exception)?adzerk.boot_reload.display.exception_node.call(null,exception):((cljs.core.seq.call(null,warnings))?adzerk.boot_reload.display.warnings_node.call(null,warnings):adzerk.boot_reload.display.reloaded_node.call(null)
)));
...
adzerk.boot_reload.display.insert_container_BANG_ = (function adzerk$boot_reload$display$insert_container_BANG_(id,p__9650){
var map__9655 = p__9650;
...
var messages = map__9655__$1;
var warnings = cljs.core.get.call(null,map__9655__$1,new cljs.core.Keyword(null,"warnings","warnings",-735437651));
var exception = cljs.core.get.call(null,map__9655__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
...
var show_BANG_ = ((function (hud,el,map__9655,map__9655__$1,messages,warnings,exception){
return (function (){
...
});})(hud,el,map__9655,map__9655__$1,messages,warnings,exception))
;
var no_prob_QMARK_ = (cljs.core.not.call(null,exception)) && (cljs.core.not.call(null,cljs.core.seq.call(null,warnings)));
var hide_BANG_ = ((function (hud,el,show_BANG_,no_prob_QMARK_,map__9655,map__9655__$1,messages,warnings,exception){
return (function (){
...
});})(hud,el,show_BANG_,no_prob_QMARK_,map__9655,map__9655__$1,messages,warnings,exception))
;
...
}catch (e9659){if((e9659 instanceof Error)){
var __9660 = e9659;
} else {
throw e9659;
