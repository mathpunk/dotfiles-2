(ns server.routes
  (:require [clojure.java.io :as io]
            ...
            [server.twitter :refer [get-tweet-by-id]]
            [org.httpkit.server :refer [run-server]]
            [server.index :refer [index-page test-page]]))
...
(defroutes routes
  ...
  (GET "/twitter" [id] (get-tweet-by-id id)))
...
(defrecord HttpKit [port reload reload-dirs]
  ...
  (start [this]
    (let [port (or port 10555)]
      ...
      (assoc this :http-kit (run-server #'server.routes/routes
