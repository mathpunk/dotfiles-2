...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__7354__auto__,writer__7355__auto__,opt__7356__auto__){
return cljs.core._write.call(null,writer__7355__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__11696 = o;
(G__11696[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
var G__11698__i = 0, G__11698__a = new Array(arguments.length -  0);
while (G__11698__i < G__11698__a.length) {G__11698__a[G__11698__i] = arguments[G__11698__i + 0]; ++G__11698__i;}
  args = new cljs.core.IndexedSeq(G__11698__a,0);
} 
return G__11697__delegate.call(this,args);};
G__11697.cljs$lang$maxFixedArity = 0;
G__11697.cljs$lang$applyTo = (function (arglist__11699){
var args = cljs.core.seq(arglist__11699);
...
if(cljs.core.truth_((function (){var and__6736__auto__ = cljs.core.some_QMARK_.call(null,jsprops);
if(and__6736__auto__){
var and__6736__auto____$1 = jsprops.hasOwnProperty("onChange");
...
var G__11705 = jsprops;
(G__11705["defaultValue"] = value);

(G__11705["onChange"] = ((function (G__11705,v,value,on_change){
return (function (p1__11702_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__11702_SHARP_);
});})(G__11705,v,value,on_change))
);

(G__11705["ref"] = ((function (G__11705,v,value,on_change){
return (function (p1__11703_SHARP_){
return (this$["cljsInputElement"] = p1__11703_SHARP_);
});})(G__11705,v,value,on_change))
);
...
var vec__11712 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__11712,(0),null);
var id = cljs.core.nth.call(null,vec__11712,(1),null);
var class$ = cljs.core.nth.call(null,vec__11712,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___11717 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___11717 == null)){
} else {
var key_11718 = temp__4661__auto___11717;
(jsprops["key"] = key_11718);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__11720 = (new reagent.impl.template.NativeWrapper());
(G__11720["name"] = c);
...
var len__7823__auto___11726 = arguments.length;
var i__7824__auto___11727 = (0);
while(true){
if((i__7824__auto___11727 < len__7823__auto___11726)){
args__7830__auto__.push((arguments[i__7824__auto___11727]));

var G__11728 = (i__7824__auto___11727 + (1));
i__7824__auto___11727 = G__11728;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__7831__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq11724){
var G__11725 = cljs.core.first.call(null,seq11724);
var seq11724__$1 = cljs.core.next.call(null,seq11724);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__11725,seq11724__$1);
});
...
break;
default:
var G__11732 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__11732;
continue;
...
var n__7663__auto___11735 = a.length;
var i_11736 = (0);
while(true){
if((i_11736 < n__7663__auto___11735)){
(a[i_11736] = reagent.impl.template.as_element.call(null,(a[i_11736])));

var G__11737 = (i_11736 + (1));
i_11736 = G__11737;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__7663__auto___11738 = a.length;
var i_11739 = (0);
while(true){
if((i_11739 < n__7663__auto___11738)){
var val_11740 = (a[i_11739]);
if((cljs.core.vector_QMARK_.call(null,val_11740)) && ((reagent.impl.template.key_from_vec.call(null,val_11740) == null))){
(o["no-key"] = true);
} else {
}

(a[i_11739] = reagent.impl.template.as_element.call(null,val_11740));

var G__11741 = (i_11739 + (1));
i_11739 = G__11741;
continue;
} else {
}
...
var ctx = ({});
var vec__11745 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__11745,(0),null);
var derefed = cljs.core.nth.call(null,vec__11745,(1),null);
...
var G__11749 = (cljs.core.count.call(null,argv) - first_child);
switch (G__11749) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__11749){
