...
var reader = (function (){var or__7619__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"file-reader","file-reader",-450847664));
...
var min_length = (function (){var or__7619__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"sanity-hint-min-length","sanity-hint-min-length",104958154));
if(cljs.core.truth_(or__7619__auto__)){
return or__7619__auto__;
} else {
return (128);
...
var file = cljs.core.get.call(null,map__15987__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__15987__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__15987__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e15986){var _e = e15986;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__6745__auto___15989 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__6745__auto___15989)){
var seen_errors_15990 = temp__6745__auto___15989;
if(cljs.core.truth_(seen_errors_15990.has(self))){
} else {
seen_errors_15990.add(self);

var temp__6747__auto___15991 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__6747__auto___15991)){
var sense_15992 = temp__6747__auto___15991;
self.message = [cljs.core.str(self.message),cljs.core.str(", a sanity hint:\n"),cljs.core.str(sense_15992)].join('');
} else {
}
}
} else {
