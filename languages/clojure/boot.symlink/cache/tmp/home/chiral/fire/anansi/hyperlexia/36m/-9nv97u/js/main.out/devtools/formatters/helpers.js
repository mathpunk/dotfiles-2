...
var G__14582 = devtools.prefs.pref.call(null,v);
v = G__14582;
continue;
} else {
return v;
...
var and__7473__auto__ = cljs.core.not.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"disable-cljs-fn-formatting","disable-cljs-fn-formatting",1903786837)));
if(and__7473__auto__){
var and__7473__auto____$1 = !(cljs.core.var_QMARK_.call(null,value));
...
var or__7485__auto__ = (function (){try{if(!((value == null))){
...
}catch (e14595){var e__12056__auto__ = e14595;
return false;
}})();
if(cljs.core.truth_(or__7485__auto__)){
return or__7485__auto__;
} else {
var or__7485__auto____$1 = (function (){try{if(!((value == null))){
...
}catch (e14599){var e__12056__auto__ = e14599;
return false;
}})();
...
}catch (e14601){var e__12056__auto__ = e14601;
return false;
}}
}
});
devtools.formatters.helpers.cljs_type_QMARK_ = (function devtools$formatters$helpers$cljs_type_QMARK_(f){
var and__7473__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__7473__auto__)){
var and__7473__auto____$1 = cljs.core.not.call(null,devtools.formatters.helpers.is_prototype_QMARK_.call(null,f));
if(and__7473__auto____$1){
...
var and__7473__auto__ = goog.isObject(value);
if(cljs.core.truth_(and__7473__auto__)){
...
var or__7485__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(or__7485__auto__)){
return or__7485__auto__;
} else {
...
var and__7473__auto__ = (function (){var or__7485__auto__ = devtools.formatters.helpers.cljs_land_value_QMARK_.call(null,value);
if(cljs.core.truth_(or__7485__auto__)){
return or__7485__auto__;
} else {
...
var vec__14606 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__14606,(0),null);
var name = cljs.core.nth.call(null,vec__14606,(1),null);
...
var and__7473__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(and__7473__auto__)){
...
var or__7485__auto__ = typeof value === 'string';
if(or__7485__auto__){
return or__7485__auto__;
} else {
var or__7485__auto____$1 = typeof value === 'number';
...
return cljs.core.some.call(null,(function (p1__14609_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__14609_SHARP_);
}),template);
});
...
var temp__6745__auto__ = devtools.formatters.helpers.pref.call(null,pref_key);
if(cljs.core.truth_(temp__6745__auto__)){
var render_pref = temp__6745__auto__;
if(render_pref === true){
