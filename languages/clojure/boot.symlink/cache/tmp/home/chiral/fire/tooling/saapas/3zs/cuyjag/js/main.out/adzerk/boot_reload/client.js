...
var host = (function (){var or__7485__auto__ = ws_host;
if(cljs.core.truth_(or__7485__auto__)){
return or__7485__auto__;
} else {
var or__7485__auto____$1 = window.location.hostname;
...
adzerk.boot_reload.client.handle = (function (){var method_table__8511__auto__ = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);
...
return (new cljs.core.MultiFn(cljs.core.symbol.call(null,"adzerk.boot-reload.client","handle"),((function (method_table__8511__auto__,prefer_table__8512__auto__,method_cache__8513__auto__,cached_hierarchy__8514__auto__,hierarchy__8515__auto__){
...
cljs.core._add_method.call(null,adzerk.boot_reload.client.handle,new cljs.core.Keyword(null,"reload","reload",863702807),(function (p__9668,opts){
var map__9669 = p__9668;
var map__9669__$1 = ((((!((map__9669 == null)))?((((map__9669.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__9669.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__9669):map__9669);
var files = cljs.core.get.call(null,map__9669__$1,new cljs.core.Keyword(null,"files","files",-472457450));
...
var len__8701__auto___9697 = arguments.length;
var i__8702__auto___9698 = (0);
while(true){
if((i__8702__auto___9698 < len__8701__auto___9697)){
args__8708__auto__.push((arguments[i__8702__auto___9698]));

var G__9699 = (i__8702__auto___9698 + (1));
i__8702__auto___9698 = G__9699;
continue;
} else {
}
break;
...
return adzerk.boot_reload.client.connect.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__8709__auto__);
});

adzerk.boot_reload.client.connect.cljs$core$IFn$_invoke$arity$variadic = (function (url,p__9688){
var vec__9689 = p__9688;
var opts = cljs.core.nth.call(null,vec__9689,(0),null);
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"opened","opened",-1451743091),((function (conn,vec__9689,opts){
return (function (evt){
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"message","message",-406056002),((function (conn,vec__9689,opts){
return (function (evt){
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"closed","closed",-919675359),((function (conn,vec__9689,opts){
return (function (evt){
...
clojure.browser.event.listen.call(null,conn,new cljs.core.Keyword(null,"error","error",-978969032),((function (conn,vec__9689,opts){
return (function (evt){
...
adzerk.boot_reload.client.connect.cljs$lang$applyTo = (function (seq9681){
var G__9682 = cljs.core.first.call(null,seq9681);
var seq9681__$1 = cljs.core.next.call(null,seq9681);
return adzerk.boot_reload.client.connect.cljs$core$IFn$_invoke$arity$variadic(G__9682,seq9681__$1);
});
