...
var o__16877__auto___21732 = (function (){var o__16877__auto__ = (function (){var o__16877__auto__ = Promise;
return goog.object.get(o__16877__auto__,"resolve").call(o__16877__auto__);
})();
return goog.object.get(o__16877__auto__,"then").call(o__16877__auto__,callback);
})();
goog.object.get(o__16877__auto___21732,"catch").call(o__16877__auto___21732,devtools.async.rethrow_outside_promise);
...
var G__21734_21735 = Error;
var target__16896__auto___21736 = G__21734_21735;
if(cljs.core.truth_(target__16896__auto___21736)){
} else {
throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str([cljs.core.str("unable to locate object path "),cljs.core.str(null),cljs.core.str(" in "),cljs.core.str(G__21734_21735)].join('')),cljs.core.str("\n"),cljs.core.str("target__16896__auto__")].join('')));
}

goog.object.set(target__16896__auto___21736,cljs.core.last.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["stackTraceLimit"], null)),Infinity);
