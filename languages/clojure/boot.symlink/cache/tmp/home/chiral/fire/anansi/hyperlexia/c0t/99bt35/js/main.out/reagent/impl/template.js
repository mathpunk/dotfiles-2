...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__8271__auto__,writer__8272__auto__,opt__8273__auto__){
return cljs.core._write.call(null,writer__8272__auto__,"reagent.impl.template/NativeWrapper");
});
...
var temp__6749__auto__ = reagent.impl.template.cache_get.call(null,reagent.impl.template.prop_name_cache,cljs.core.name.call(null,k));
...
var k_SINGLEQUOTE_ = temp__6749__auto__;
...
var G__10546 = o;
(G__10546[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
var temp__6749__auto__ = (id_class["className"]);
if((temp__6749__auto__ == null)){
return p__$1;
} else {
var class$ = temp__6749__auto__;
...
var temp__6751__auto__ = (this$["cljsInputElement"]);
...
return reagent.impl.batching.do_after_render.call(null,((function (node_value,rendered_value,dom_value,node,temp__6751__auto__){
return (function (){
return reagent.impl.template.input_set_value.call(null,this$);
});})(node_value,rendered_value,dom_value,node,temp__6751__auto__))
);
} else {
...
if(cljs.core.truth_((function (){var and__7607__auto__ = cljs.core.some_QMARK_.call(null,jsprops);
if(and__7607__auto__){
var and__7607__auto____$1 = jsprops.hasOwnProperty("onChange");
...
var G__10618 = jsprops;
(G__10618["defaultValue"] = value);

(G__10618["onChange"] = ((function (G__10618,v,value,on_change){
return (function (p1__10612_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__10612_SHARP_);
});})(G__10618,v,value,on_change))
);

(G__10618["ref"] = ((function (G__10618,v,value,on_change){
return (function (p1__10613_SHARP_){
return (this$["cljsInputElement"] = p1__10613_SHARP_);
});})(G__10618,v,value,on_change))
);
...
var vec__10644 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__10644,(0),null);
var id = cljs.core.nth.call(null,vec__10644,(1),null);
var class$ = cljs.core.nth.call(null,vec__10644,(2),null);
...
var temp__6749__auto__ = reagent.impl.template.get_key.call(null,cljs.core.meta.call(null,v));
if((temp__6749__auto__ == null)){
return reagent.impl.template.get_key.call(null,cljs.core.nth.call(null,v,(1),null));
} else {
var k = temp__6749__auto__;
return k;
}
});
...
var jsprops = ({"argv": v});
var temp__6751__auto___10663 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__6751__auto___10663 == null)){
} else {
var key_10664 = temp__6751__auto___10663;
(jsprops["key"] = key_10664);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__10670 = (new reagent.impl.template.NativeWrapper());
(G__10670["name"] = c);
...
var temp__6749__auto__ = reagent.impl.template.cache_get.call(null,reagent.impl.template.tag_name_cache,x);
if((temp__6749__auto__ == null)){
return (reagent.impl.template.tag_name_cache[x] = reagent.impl.template.parse_tag.call(null,x));
} else {
var s = temp__6749__auto__;
return s;
}
});
...
var len__8835__auto___10690 = arguments.length;
var i__8836__auto___10691 = (0);
while(true){
if((i__8836__auto___10691 < len__8835__auto___10690)){
args__8842__auto__.push((arguments[i__8836__auto___10691]));

var G__10695 = (i__8836__auto___10691 + (1));
i__8836__auto___10691 = G__10695;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__8843__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq10686){
var G__10687 = cljs.core.first.call(null,seq10686);
var seq10686__$1 = cljs.core.next.call(null,seq10686);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__10687,seq10686__$1);
});
...
break;
default:
var G__10721 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__10721;
continue;
...
var n__8635__auto___10754 = a.length;
var i_10755 = (0);
while(true){
if((i_10755 < n__8635__auto___10754)){
(a[i_10755] = reagent.impl.template.as_element.call(null,(a[i_10755])));

var G__10756 = (i_10755 + (1));
i_10755 = G__10756;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__8635__auto___10766 = a.length;
var i_10767 = (0);
while(true){
if((i_10767 < n__8635__auto___10766)){
var val_10768 = (a[i_10767]);
if((cljs.core.vector_QMARK_.call(null,val_10768)) && ((reagent.impl.template.key_from_vec.call(null,val_10768) == null))){
(o["no-key"] = true);
} else {
}

(a[i_10767] = reagent.impl.template.as_element.call(null,val_10768));

var G__10772 = (i_10767 + (1));
i_10767 = G__10772;
continue;
} else {
}
...
var ctx = ({});
var vec__10777 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__10777,(0),null);
var derefed = cljs.core.nth.call(null,vec__10777,(1),null);
...
var G__10793 = (cljs.core.count.call(null,argv) - first_child);
switch (G__10793) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__10793){
