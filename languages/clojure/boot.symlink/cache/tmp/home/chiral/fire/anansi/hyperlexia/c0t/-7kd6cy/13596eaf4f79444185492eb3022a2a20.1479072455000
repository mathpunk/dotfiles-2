...
var vec__9369 = p__9365;
var attr = cljs.core.nth.call(null,vec__9369,(0),null);
var v = cljs.core.nth.call(null,vec__9369,(1),null);
...
var args9373 = [];
var len__8835__auto___9376 = arguments.length;
var i__8836__auto___9377 = (0);
while(true){
if((i__8836__auto___9377 < len__8835__auto___9376)){
args9373.push((arguments[i__8836__auto___9377]));

var G__9378 = (i__8836__auto___9377 + (1));
i__8836__auto___9377 = G__9378;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args9373.length)].join('')));
...
var len__8835__auto___9391 = arguments.length;
var i__8836__auto___9392 = (0);
while(true){
if((i__8836__auto___9392 < len__8835__auto___9391)){
args__8842__auto__.push((arguments[i__8836__auto___9392]));

var G__9393 = (i__8836__auto___9392 + (1));
i__8836__auto___9392 = G__9393;
continue;
} else {
}
break;
...
return adzerk.boot_reload.display.style.cljs$core$IFn$_invoke$arity$variadic(argseq__8843__auto__);
});
...
adzerk.boot_reload.display.style.cljs$lang$applyTo = (function (seq9383){
return adzerk.boot_reload.display.style.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq9383));
});
...
adzerk.boot_reload.display.exception_node = (function adzerk$boot_reload$display$exception_node(p__9419){
var map__9424 = p__9419;
...
var data = map__9424__$1;
var message = cljs.core.get.call(null,map__9424__$1,new cljs.core.Keyword(null,"message","message",-406056002));
var line = cljs.core.get.call(null,map__9424__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.call(null,map__9424__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var G__9426 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),null,message);
goog.events.listen(G__9426,goog.events.EventType.CLICK,((function (G__9426,map__9424,map__9424__$1,data,message,line,file){
return (function (){
return adzerk.boot_reload.display.open_file.call(null,data);
});})(G__9426,map__9424,map__9424__$1,data,message,line,file))
);

return G__9426;
});
adzerk.boot_reload.display.warning_node = (function adzerk$boot_reload$display$warning_node(p__9431){
var map__9437 = p__9431;
...
adzerk.boot_reload.display.construct_hud_node = (function adzerk$boot_reload$display$construct_hud_node(p__9444){
var map__9448 = p__9444;
...
var messages = map__9448__$1;
var warnings = cljs.core.get.call(null,map__9448__$1,new cljs.core.Keyword(null,"warnings","warnings",-735437651));
var exception = cljs.core.get.call(null,map__9448__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
var G__9450 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"pad","pad",-36734541),new cljs.core.Keyword(null,"flex","flex",-1425124628),new cljs.core.Keyword(null,"flex-c","flex-c",1898731114),(cljs.core.truth_(exception)?new cljs.core.Keyword(null,"bg-red","bg-red",-1645498040):((cljs.core.seq.call(null,warnings))?new cljs.core.Keyword(null,"bg-yellow","bg-yellow",-1293468429):new cljs.core.Keyword(null,"bg-clear","bg-clear",-673074101)
))));
goog.dom.append(G__9450,adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"logo","logo",1237980263),new cljs.core.Keyword(null,"mr10","mr10",-144509621)),adzerk.boot_reload.display.logo_node.call(null,adzerk.boot_reload.display.cljs_logo)));

goog.dom.append(G__9450,(cljs.core.truth_(exception)?adzerk.boot_reload.display.exception_node.call(null,exception):((cljs.core.seq.call(null,warnings))?adzerk.boot_reload.display.warnings_node.call(null,warnings):adzerk.boot_reload.display.reloaded_node.call(null)
)));
...
adzerk.boot_reload.display.insert_container_BANG_ = (function adzerk$boot_reload$display$insert_container_BANG_(id,p__9460){
var map__9463 = p__9460;
var map__9463__$1 = ((((!((map__9463 == null)))?((((map__9463.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__9463.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__9463):map__9463);
var messages = map__9463__$1;
var warnings = cljs.core.get.call(null,map__9463__$1,new cljs.core.Keyword(null,"warnings","warnings",-735437651));
var exception = cljs.core.get.call(null,map__9463__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
...
var show_BANG_ = ((function (hud,el,map__9463,map__9463__$1,messages,warnings,exception){
return (function (){
...
});})(hud,el,map__9463,map__9463__$1,messages,warnings,exception))
;
var no_prob_QMARK_ = (cljs.core.not.call(null,exception)) && (cljs.core.not.call(null,cljs.core.seq.call(null,warnings)));
var hide_BANG_ = ((function (hud,el,show_BANG_,no_prob_QMARK_,map__9463,map__9463__$1,messages,warnings,exception){
return (function (){
...
});})(hud,el,show_BANG_,no_prob_QMARK_,map__9463,map__9463__$1,messages,warnings,exception))
;
...
}catch (e9512){if((e9512 instanceof Error)){
var __9524 = e9512;
} else {
throw e9512;
