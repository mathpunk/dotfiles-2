...
var o__12260__auto___14863 = (function (){var o__12260__auto__ = (function (){var o__12260__auto__ = Promise;
return goog.object.get(o__12260__auto__,"resolve").call(o__12260__auto__);
})();
return goog.object.get(o__12260__auto__,"then").call(o__12260__auto__,callback);
})();
goog.object.get(o__12260__auto___14863,"catch").call(o__12260__auto___14863,devtools.async.rethrow_outside_promise);
...
var G__14874_14878 = Error;
var target__12288__auto___14879 = G__14874_14878;
if(cljs.core.truth_(target__12288__auto___14879)){
} else {
throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str([cljs.core.str("unable to locate object path "),cljs.core.str(null),cljs.core.str(" in "),cljs.core.str(G__14874_14878)].join('')),cljs.core.str("\n"),cljs.core.str("target__12288__auto__")].join('')));
}

goog.object.set(target__12288__auto___14879,cljs.core.last.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["stackTraceLimit"], null)),Infinity);
