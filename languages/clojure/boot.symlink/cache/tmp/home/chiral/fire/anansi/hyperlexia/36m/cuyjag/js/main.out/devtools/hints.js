...
var temp__6745__auto__ = cljs.core.deref.call(null,devtools.hints.processed_errors);
if(cljs.core.truth_(temp__6745__auto__)){
var val = temp__6745__auto__;
return val;
} else {
...
var reader = (function (){var or__7485__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"file-reader","file-reader",-450847664));
...
var min_length = (function (){var or__7485__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"sanity-hint-min-length","sanity-hint-min-length",104958154));
if(cljs.core.truth_(or__7485__auto__)){
return or__7485__auto__;
} else {
return (128);
...
var map__15174 = top_item;
var map__15174__$1 = ((((!((map__15174 == null)))?((((map__15174.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__15174.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__15174):map__15174);
var file = cljs.core.get.call(null,map__15174__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__15174__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__15174__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e15173){var _e = e15173;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__6745__auto___15176 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__6745__auto___15176)){
var seen_errors_15177 = temp__6745__auto___15176;
if(cljs.core.truth_(seen_errors_15177.has(self))){
} else {
seen_errors_15177.add(self);

var temp__6747__auto___15180 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__6747__auto___15180)){
var sense_15181 = temp__6747__auto___15180;
self.message = [cljs.core.str(self.message),cljs.core.str(", a sanity hint:\n"),cljs.core.str(sense_15181)].join('');
} else {
}
}
} else {
...
var temp__6747__auto__ = devtools.hints.error_object_sense.call(null,error);
if(cljs.core.truth_(temp__6747__auto__)){
var sense = temp__6747__auto__;
