...
var G__13593 = o;
(G__13593[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
var G__13602 = jsprops;
(G__13602["defaultValue"] = value);

(G__13602["onChange"] = ((function (G__13602,v,value,on_change){
return (function (p1__13599_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__13599_SHARP_);
});})(G__13602,v,value,on_change))
);

(G__13602["ref"] = ((function (G__13602,v,value,on_change){
return (function (p1__13600_SHARP_){
return (this$["cljsInputElement"] = p1__13600_SHARP_);
});})(G__13602,v,value,on_change))
);
...
var vec__13609 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__13609,(0),null);
var id = cljs.core.nth.call(null,vec__13609,(1),null);
var class$ = cljs.core.nth.call(null,vec__13609,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___13614 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___13614 == null)){
} else {
var key_13615 = temp__4661__auto___13614;
(jsprops["key"] = key_13615);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__13617 = (new reagent.impl.template.NativeWrapper());
(G__13617["name"] = c);
...
var len__7823__auto___13623 = arguments.length;
var i__7824__auto___13624 = (0);
while(true){
if((i__7824__auto___13624 < len__7823__auto___13623)){
args__7830__auto__.push((arguments[i__7824__auto___13624]));

var G__13625 = (i__7824__auto___13624 + (1));
i__7824__auto___13624 = G__13625;
continue;
} else {
}
break;
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq13621){
var G__13622 = cljs.core.first.call(null,seq13621);
var seq13621__$1 = cljs.core.next.call(null,seq13621);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__13622,seq13621__$1);
});
...
break;
default:
var G__13629 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__13629;
continue;
...
var n__7663__auto___13632 = a.length;
var i_13633 = (0);
while(true){
if((i_13633 < n__7663__auto___13632)){
(a[i_13633] = reagent.impl.template.as_element.call(null,(a[i_13633])));

var G__13634 = (i_13633 + (1));
i_13633 = G__13634;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__7663__auto___13635 = a.length;
var i_13636 = (0);
while(true){
if((i_13636 < n__7663__auto___13635)){
var val_13637 = (a[i_13636]);
if((cljs.core.vector_QMARK_.call(null,val_13637)) && ((reagent.impl.template.key_from_vec.call(null,val_13637) == null))){
(o["no-key"] = true);
} else {
}

(a[i_13636] = reagent.impl.template.as_element.call(null,val_13637));

var G__13638 = (i_13636 + (1));
i_13636 = G__13638;
continue;
} else {
}
...
var ctx = ({});
var vec__13642 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__13642,(0),null);
var derefed = cljs.core.nth.call(null,vec__13642,(1),null);
...
var G__13646 = (cljs.core.count.call(null,argv) - first_child);
switch (G__13646) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__13646){
