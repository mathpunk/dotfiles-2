...
var G__19254 = devtools.prefs.pref.call(null,v);
v = G__19254;
continue;
} else {
return v;
...
}catch (e19267){var e__16768__auto__ = e19267;
return false;
}})();
...
}catch (e19271){var e__16768__auto__ = e19271;
return false;
}})();
...
}catch (e19273){var e__16768__auto__ = e19273;
return false;
}}
}
});
...
var vec__19278 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__19278,(0),null);
var name = cljs.core.nth.call(null,vec__19278,(1),null);
...
return cljs.core.some.call(null,(function (p1__19281_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__19281_SHARP_);
}),template);
});
