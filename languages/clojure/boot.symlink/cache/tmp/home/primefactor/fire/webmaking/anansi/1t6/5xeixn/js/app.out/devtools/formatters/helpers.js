...
var G__19350 = devtools.prefs.pref.call(null,v);
v = G__19350;
continue;
} else {
return v;
...
}catch (e19363){var e__16913__auto__ = e19363;
return false;
}})();
...
}catch (e19367){var e__16913__auto__ = e19367;
return false;
}})();
...
}catch (e19369){var e__16913__auto__ = e19369;
return false;
}}
}
});
...
var vec__19374 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__19374,(0),null);
var name = cljs.core.nth.call(null,vec__19374,(1),null);
...
return cljs.core.some.call(null,(function (p1__19377_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__19377_SHARP_);
}),template);
});
