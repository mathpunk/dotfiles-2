...
return (function (p__9266){
var vec__9267 = p__9266;
var attr = cljs.core.nth.call(null,vec__9267,(0),null);
...
var args9295 = [];
var len__8701__auto___9302 = arguments.length;
var i__8702__auto___9303 = (0);
while(true){
if((i__8702__auto___9303 < len__8701__auto___9302)){
args9295.push((arguments[i__8702__auto___9303]));

var G__9304 = (i__8702__auto___9303 + (1));
i__8702__auto___9303 = G__9304;
continue;
} else {
}
break;
...
var len__8701__auto___9314 = arguments.length;
var i__8702__auto___9315 = (0);
while(true){
if((i__8702__auto___9315 < len__8701__auto___9314)){
args__8708__auto__.push((arguments[i__8702__auto___9315]));

var G__9316 = (i__8702__auto___9315 + (1));
i__8702__auto___9315 = G__9316;
continue;
} else {
}
break;
...
adzerk.boot_reload.display.style.cljs$lang$applyTo = (function (seq9309){
return adzerk.boot_reload.display.style.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq9309));
});
...
adzerk.boot_reload.display.exception_node = (function adzerk$boot_reload$display$exception_node(p__9337){
var map__9346 = p__9337;
...
var data = map__9346__$1;
var message = cljs.core.get.call(null,map__9346__$1,new cljs.core.Keyword(null,"message","message",-406056002));
var line = cljs.core.get.call(null,map__9346__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.call(null,map__9346__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var G__9348 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),null,message);
goog.events.listen(G__9348,goog.events.EventType.CLICK,((function (G__9348,map__9346,map__9346__$1,data,message,line,file){
return (function (){
return adzerk.boot_reload.display.open_file.call(null,data);
});})(G__9348,map__9346,map__9346__$1,data,message,line,file))
);

return G__9348;
});
adzerk.boot_reload.display.warning_node = (function adzerk$boot_reload$display$warning_node(p__9352){
var map__9356 = p__9352;
...
var data = map__9356__$1;
var message = cljs.core.get.call(null,map__9356__$1,new cljs.core.Keyword(null,"message","message",-406056002));
var line = cljs.core.get.call(null,map__9356__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.call(null,map__9356__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
goog.events.listen(G__9358,goog.events.EventType.CLICK,((function (G__9358,map__9356,map__9356__$1,data,message,line,file){
return (function (){
return adzerk.boot_reload.display.open_file.call(null,data);
});})(G__9358,map__9356,map__9356__$1,data,message,line,file))
);
...
adzerk.boot_reload.display.construct_hud_node = (function adzerk$boot_reload$display$construct_hud_node(p__9359){
var map__9363 = p__9359;
...
var messages = map__9363__$1;
var warnings = cljs.core.get.call(null,map__9363__$1,new cljs.core.Keyword(null,"warnings","warnings",-735437651));
var exception = cljs.core.get.call(null,map__9363__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
var G__9365 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"pad","pad",-36734541),new cljs.core.Keyword(null,"flex","flex",-1425124628),new cljs.core.Keyword(null,"flex-c","flex-c",1898731114),(cljs.core.truth_(exception)?new cljs.core.Keyword(null,"bg-red","bg-red",-1645498040):((cljs.core.seq.call(null,warnings))?new cljs.core.Keyword(null,"bg-yellow","bg-yellow",-1293468429):new cljs.core.Keyword(null,"bg-clear","bg-clear",-673074101)
))));
goog.dom.append(G__9365,adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"logo","logo",1237980263),new cljs.core.Keyword(null,"mr10","mr10",-144509621)),adzerk.boot_reload.display.logo_node.call(null,adzerk.boot_reload.display.cljs_logo)));

goog.dom.append(G__9365,(cljs.core.truth_(exception)?adzerk.boot_reload.display.exception_node.call(null,exception):((cljs.core.seq.call(null,warnings))?adzerk.boot_reload.display.warnings_node.call(null,warnings):adzerk.boot_reload.display.reloaded_node.call(null)
)));
...
adzerk.boot_reload.display.insert_container_BANG_ = (function adzerk$boot_reload$display$insert_container_BANG_(id,p__9379){
var map__9384 = p__9379;
...
var messages = map__9384__$1;
var warnings = cljs.core.get.call(null,map__9384__$1,new cljs.core.Keyword(null,"warnings","warnings",-735437651));
var exception = cljs.core.get.call(null,map__9384__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
...
var show_BANG_ = ((function (hud,el,map__9384,map__9384__$1,messages,warnings,exception){
return (function (){
...
});})(hud,el,map__9384,map__9384__$1,messages,warnings,exception))
;
var no_prob_QMARK_ = (cljs.core.not.call(null,exception)) && (cljs.core.not.call(null,cljs.core.seq.call(null,warnings)));
var hide_BANG_ = ((function (hud,el,show_BANG_,no_prob_QMARK_,map__9384,map__9384__$1,messages,warnings,exception){
return (function (){
...
});})(hud,el,show_BANG_,no_prob_QMARK_,map__9384,map__9384__$1,messages,warnings,exception))
;
...
}catch (e9398){if((e9398 instanceof Error)){
var __9399 = e9398;
} else {
throw e9398;
