...
cljs.core.println.call(null,"add-pin called!");

var ent = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("pin","description","pin/description",-1428474107),"A pin's description"], null);
cljs.core.println.call(null,"adding pin");
...
cljs.core.println.call(null,"data arrives; maps with keys such as ",cljs.core.keys.call(null,cljs.core.first.call(null,new cljs.core.Keyword(null,"posts","posts",760043164).cljs$core$IFn$_invoke$arity$1(edn))));

cljs.core.reset_BANG_.call(null,anansi.reading.app.state,edn);

cljs.core.println.call(null,"state set: user ",new cljs.core.Keyword(null,"user","user",1532431356).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,anansi.reading.app.state)),", date ",new cljs.core.Keyword(null,"date","date",-1463434462).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,anansi.reading.app.state)),", ",cljs.core.count.call(null,new cljs.core.Keyword(null,"posts","posts",760043164).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,anansi.reading.app.state)))," posts");
