...
var len__7823__auto___19380 = arguments.length;
var i__7824__auto___19381 = (0);
while(true){
if((i__7824__auto___19381 < len__7823__auto___19380)){
args__7830__auto__.push((arguments[i__7824__auto___19381]));

var G__19382 = (i__7824__auto___19381 + (1));
i__7824__auto___19381 = G__19382;
continue;
} else {
}
break;
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq19377){
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__19378,G__19379,seq19377__$2);
});
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__19383_SHARP_){
return cljs.core.some_QMARK_.call(null,cljs.core.meta.call(null,p1__19383_SHARP_));
})))){
...
}catch (e19396){var e__16902__auto__ = e19396;
return false;
}})();
if(cljs.core.truth_(or__6748__auto__)){
return or__6748__auto__;
...
}catch (e19398){var e__16902__auto__ = e19398;
return false;
}}
})())){
...
var _STAR_current_state_STAR_19403 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__19404 = opts;
...
var markup_db = cljs.core.get.call(null,map__19404__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_19403;
}});
...
;
var temp__4655__auto___19409 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__4655__auto___19409)){
var managed_print_level_19410 = temp__4655__auto___19409;
var _STAR_print_level_STAR_19408_19411 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_19410;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_19408_19411,managed_print_level_19410,temp__4655__auto___19409,writer,opts,job_fn){
return (function (p1__19406_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__19406_SHARP_,null);
});})(_STAR_print_level_STAR_19408_19411,managed_print_level_19410,temp__4655__auto___19409,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_19408_19411;
}} else {
job_fn.call(null);
}
