...
var len__7823__auto___19295 = arguments.length;
var i__7824__auto___19296 = (0);
while(true){
if((i__7824__auto___19296 < len__7823__auto___19295)){
args__7830__auto__.push((arguments[i__7824__auto___19296]));

var G__19297 = (i__7824__auto___19296 + (1));
i__7824__auto___19296 = G__19297;
continue;
} else {
}
break;
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__7831__auto__);
});
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq19292){
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__19293,G__19294,seq19292__$2);
});
...
if(cljs.core.truth_((function (){var or__6748__auto__ = devtools.formatters.helpers.directly_printable_QMARK_.call(null,value);
...
devtools.formatters.printing.TemplateWriter.cljs$lang$ctorPrWriter = (function (this__7354__auto__,writer__7355__auto__,opt__7356__auto__){
return cljs.core._write.call(null,writer__7355__auto__,"devtools.formatters.printing/TemplateWriter");
});
...
if(cljs.core.truth_((function (){var and__6736__auto__ = cljs.core.not.call(null,devtools.formatters.printing.already_reference_QMARK_.call(null,group));
if(and__6736__auto__){
var or__6748__auto__ = devtools.formatters.helpers.expandable_QMARK_.call(null,obj);
if(cljs.core.truth_(or__6748__auto__)){
return or__6748__auto__;
} else {
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__19298_SHARP_){
return cljs.core.some_QMARK_.call(null,cljs.core.meta.call(null,p1__19298_SHARP_));
})))){
...
var map__19307 = opts;
var map__19307__$1 = ((((!((map__19307 == null)))?((((map__19307.cljs$lang$protocol_mask$partition0$ & (64))) || (map__19307.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__19307):map__19307);
var markup_db = cljs.core.get.call(null,map__19307__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
if(cljs.core.truth_((function (){var or__6748__auto__ = (function (){try{if(!((obj == null))){
...
}catch (e19311){var e__16768__auto__ = e19311;
return false;
}})();
if(cljs.core.truth_(or__6748__auto__)){
return or__6748__auto__;
...
}catch (e19313){var e__16768__auto__ = e19313;
return false;
}}
})())){
...
var _STAR_current_state_STAR_19318 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__19319 = opts;
...
var markup_db = cljs.core.get.call(null,map__19319__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_19318;
}});
...
;
var temp__4655__auto___19324 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__4655__auto___19324)){
var managed_print_level_19325 = temp__4655__auto___19324;
var _STAR_print_level_STAR_19323_19326 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_19325;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_19323_19326,managed_print_level_19325,temp__4655__auto___19324,writer,opts,job_fn){
return (function (p1__19321_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__19321_SHARP_,null);
});})(_STAR_print_level_STAR_19323_19326,managed_print_level_19325,temp__4655__auto___19324,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_19323_19326;
}} else {
job_fn.call(null);
}
