...
var and__6736__auto__ = cljs.core.not.call(null,devtools.formatters.state.prevent_recursion_QMARK_.call(null));
if(and__6736__auto__){
var or__6748__auto__ = devtools.formatters.helpers.cljs_value_QMARK_.call(null,value);
...
}catch (e19736){var e__16768__auto__ = e19736;
return false;
...
}catch (e19738){var e__16768__auto__ = e19738;
return false;
...
}catch (e19744){var e__16768__auto__ = e19744;
return false;
...
}catch (e19746){var e__16768__auto__ = e19746;
return false;
...
}catch (e19752){var e__16768__auto__ = e19752;
return false;
}})())){
...
}catch (e19754){var e__16768__auto__ = e19754;
return false;
}})())){
...
var _STAR_current_state_STAR_19757 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = (function (){var or__6748__auto__ = config;
if(cljs.core.truth_(or__6748__auto__)){
return or__6748__auto__;
} else {
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_19757;
}});
});
...
return (function() { 
var G__19760__delegate = function (args){
try{return cljs.core.apply.call(null,f,args);
}catch (e19759){var e = e19759;
console.error("CLJS DevTools internal error:",e);

return null;
}};
var G__19760 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__19761__i = 0, G__19761__a = new Array(arguments.length -  0);
while (G__19761__i < G__19761__a.length) {G__19761__a[G__19761__i] = arguments[G__19761__i + 0]; ++G__19761__i;}
  args = new cljs.core.IndexedSeq(G__19761__a,0);
} 
return G__19760__delegate.call(this,args);};
G__19760.cljs$lang$maxFixedArity = 0;
G__19760.cljs$lang$applyTo = (function (arglist__19762){
var args = cljs.core.seq(arglist__19762);
return G__19760__delegate(args);
});
...
var pre_handler = (function (){var or__6748__auto__ = devtools.prefs.pref.call(null,pre_handler_key);
if(cljs.core.truth_(or__6748__auto__)){
return or__6748__auto__;
} else {
...
var post_handler = (function (){var or__6748__auto__ = devtools.prefs.pref.call(null,post_handler_key);
if(cljs.core.truth_(or__6748__auto__)){
return or__6748__auto__;
} else {
return cljs.core.identity;
