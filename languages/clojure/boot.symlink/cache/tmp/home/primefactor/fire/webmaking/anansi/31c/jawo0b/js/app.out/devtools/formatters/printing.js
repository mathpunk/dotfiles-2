...
var len__7823__auto___19391 = arguments.length;
var i__7824__auto___19392 = (0);
while(true){
if((i__7824__auto___19392 < len__7823__auto___19391)){
args__7830__auto__.push((arguments[i__7824__auto___19392]));

var G__19393 = (i__7824__auto___19392 + (1));
i__7824__auto___19392 = G__19393;
continue;
} else {
}
break;
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq19388){
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__19389,G__19390,seq19388__$2);
});
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__19394_SHARP_){
return cljs.core.some_QMARK_.call(null,cljs.core.meta.call(null,p1__19394_SHARP_));
})))){
...
var markup_db = cljs.core.get.call(null,map__19403__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e19407){var e__16913__auto__ = e19407;
return false;
}})();
if(cljs.core.truth_(or__6748__auto__)){
return or__6748__auto__;
...
}catch (e19409){var e__16913__auto__ = e19409;
return false;
}}
})())){
...
var _STAR_current_state_STAR_19414 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__19415 = opts;
var map__19415__$1 = ((((!((map__19415 == null)))?((((map__19415.cljs$lang$protocol_mask$partition0$ & (64))) || (map__19415.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__19415):map__19415);
var markup_db = cljs.core.get.call(null,map__19415__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_19414;
}});
...
;
var temp__4655__auto___19420 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__4655__auto___19420)){
var managed_print_level_19421 = temp__4655__auto___19420;
var _STAR_print_level_STAR_19419_19422 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_19421;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_19419_19422,managed_print_level_19421,temp__4655__auto___19420,writer,opts,job_fn){
return (function (p1__19417_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__19417_SHARP_,null);
});})(_STAR_print_level_STAR_19419_19422,managed_print_level_19421,temp__4655__auto___19420,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_19419_19422;
}} else {
job_fn.call(null);
}
