...
var o__12849__auto__ = (function (){var temp__6747__auto__ = goog.object.get(window,"cljs");
if(cljs.core.truth_(temp__6747__auto__)){
var o__12861__auto__ = temp__6747__auto__;
return goog.object.get(o__12861__auto__,"core");
} else {
return null;
}
})();
return goog.object.get(o__12849__auto__,"js_reserved_QMARK_").call(o__12849__auto__,x);
});
devtools.munging.get_fn_source_safely = (function devtools$munging$get_fn_source_safely(f){
try{var o__12849__auto__ = f;
return goog.object.get(o__12849__auto__,"toString").call(o__12849__auto__);
}catch (e15260){var _ = e15260;
return "";
}});
...
try{var o__12849__auto___15263 = t;
goog.object.get(o__12849__auto___15263,"cljs$lang$ctorPrWriter").call(o__12849__auto___15263,t,writer);
}catch (e15262){var __15264 = e15262;
}
...
var char_code = (function (){var o__12849__auto__ = (new String(char$));
return goog.object.get(o__12849__auto__,"charCodeAt").call(o__12849__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__12849__auto__ = String;
return goog.object.get(o__12849__auto__,"fromCharCode").call(o__12849__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__15266 = num_code;
switch (G__15266) {
case (1):
return (185);
...
var o__12849__auto__ = String;
return goog.object.get(o__12849__auto__,"fromCharCode").call(o__12849__auto__,superscript_code);
});
/**
...
}catch (e15272){var e__12877__auto__ = e15272;
return false;
}})())){
...
var vec__15273 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__15273,(0),null);
...
var or__7619__auto__ = (function (){var temp__6745__auto__ = cljs.core.re_matches.call(null,/(.*)\$/,s);
if(cljs.core.truth_(temp__6745__auto__)){
...
var temp__6747__auto____$1 = goog.object.get(o__12862__auto__,"dependencies_");
if(cljs.core.truth_(temp__6747__auto____$1)){
var o__12861__auto__ = temp__6747__auto____$1;
return goog.object.get(o__12861__auto__,"nameToPath");
} else {
return null;
}
} else {
...
var len__8835__auto___15282 = arguments.length;
var i__8836__auto___15283 = (0);
while(true){
if((i__8836__auto___15283 < len__8835__auto___15282)){
args__8842__auto__.push((arguments[i__8836__auto___15283]));

var G__15284 = (i__8836__auto___15283 + (1));
i__8836__auto___15283 = G__15284;
continue;
} else {
}
break;
...
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__8843__auto__);
});

devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__15278){
var vec__15279 = p__15278;
var ns_detector = cljs.core.nth.call(null,vec__15279,(0),null);
var effective_detector = (function (){var or__7619__auto__ = ns_detector;
if(cljs.core.truth_(or__7619__auto__)){
return or__7619__auto__;
} else {
...
var G__15285 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__15286 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__15285;
remaining_tokens = G__15286;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq15276){
var G__15277 = cljs.core.first.call(null,seq15276);
var seq15276__$1 = cljs.core.next.call(null,seq15276);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__15277,seq15276__$1);
});
...
break;
default:
var o__12849__auto__ = window;
return goog.object.get(o__12849__auto__,"parseInt").call(o__12849__auto__,arity,(10));
...
var vec__15294 = cljs.core.split_with.call(null,(function (p1__15290_SHARP_){
return cljs.core.not_EQ_.call(null,p1__15290_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__15294,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__15294,(1),null);
...
var vec__15300 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__15300,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__15300,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__15303 = cljs.core.rest.call(null,remaining_tokens);
var G__15304 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__15303;
name_tokens = G__15304;
continue;
} else {
...
var args15305 = [];
var len__8835__auto___15317 = arguments.length;
var i__8836__auto___15318 = (0);
while(true){
if((i__8836__auto___15318 < len__8835__auto___15317)){
args15305.push((arguments[i__8836__auto___15318]));

var G__15319 = (i__8836__auto___15318 + (1));
i__8836__auto___15318 = G__15319;
continue;
} else {
}
break;
...
var vec__15308 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__15308,(0),null);
var arity = cljs.core.nth.call(null,vec__15308,(1),null);
var vec__15311 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__15311,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__15311,(1),null);
var vec__15314 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__15314,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__15314,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__15314,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__15314,(3),null);
...
var args15321 = [];
var len__8835__auto___15327 = arguments.length;
var i__8836__auto___15328 = (0);
while(true){
if((i__8836__auto___15328 < len__8835__auto___15327)){
args15321.push((arguments[i__8836__auto___15328]));

var G__15329 = (i__8836__auto___15328 + (1));
i__8836__auto___15328 = G__15329;
continue;
} else {
}
break;
...
var vec__15324 = result;
var munged_ns = cljs.core.nth.call(null,vec__15324,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__15324,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__15324,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__15324,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__15324,(4),null);
var arity = cljs.core.nth.call(null,vec__15324,(5),null);
...
if(cljs.core.truth_(temp__6745__auto__)){
var vec__15337 = temp__6745__auto__;
var munged_name = cljs.core.nth.call(null,vec__15337,(0),null);
var args = cljs.core.nth.call(null,vec__15337,(1),null);
var vec__15340 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__15340,(0),null);
var name = cljs.core.nth.call(null,vec__15340,(1),null);
...
var G__15343 = (arity + (1));
var G__15344 = (function (){var temp__6745__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__6745__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__15345){
var vec__15349 = p__15345;
var arity = cljs.core.nth.call(null,vec__15349,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__15349,(1),null);
...
var fixed_arities = devtools.munging.collect_fn_fixed_arities.call(null,f,(function (){var or__7619__auto__ = max_fixed_arity;
if(cljs.core.truth_(or__7619__auto__)){
return or__7619__auto__;
} else {
...
return cljs.core.get.call(null,arities,p1__15352_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__15353_SHARP_);
...
var args__8842__auto__ = [];
var len__8835__auto___15360 = arguments.length;
var i__8836__auto___15361 = (0);
while(true){
if((i__8836__auto___15361 < len__8835__auto___15360)){
args__8842__auto__.push((arguments[i__8836__auto___15361]));

var G__15362 = (i__8836__auto___15361 + (1));
i__8836__auto___15361 = G__15362;
continue;
} else {
}
break;
...
var argseq__8843__auto__ = ((((1) < args__8842__auto__.length))?(new cljs.core.IndexedSeq(args__8842__auto__.slice((1)),(0),null)):null);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__8843__auto__);
});

devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__15356){
var vec__15357 = p__15356;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__15357,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq15354){
var G__15355 = cljs.core.first.call(null,seq15354);
var seq15354__$1 = cljs.core.next.call(null,seq15354);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__15355,seq15354__$1);
});
...
var G__15364 = (((arg instanceof cljs.core.Keyword))?arg.fqn:null);
switch (G__15364) {
...
return devtools.munging.args_lists_to_strings.call(null,devtools.munging.arities_to_args_lists.call(null,(function (){var or__7619__auto__ = devtools.munging.collect_fn_arities.call(null,f);
if(cljs.core.truth_(or__7619__auto__)){
return or__7619__auto__;
} else {
...
return [cljs.core.str((cljs.core.truth_((function (){var and__7607__auto__ = include_ns_QMARK_;
...
return [cljs.core.str((cljs.core.truth_(include_protocol_ns_QMARK_)?protocol_ns:null)),cljs.core.str(((!(cljs.core.empty_QMARK_.call(null,protocol_name)))?[cljs.core.str((cljs.core.truth_(include_protocol_ns_QMARK_)?".":null)),cljs.core.str(protocol_name)].join(''):null)),cljs.core.str(((!(cljs.core.empty_QMARK_.call(null,protocol_method)))?[cljs.core.str((cljs.core.truth_((function (){var or__7619__auto__ = include_protocol_ns_QMARK_;
if(cljs.core.truth_(or__7619__auto__)){
return or__7619__auto__;
} else {
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__15371__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__15371__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__15371__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__15371__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__15372 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__15372,(0),null);
var fn_name = cljs.core.nth.call(null,vec__15372,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__15372,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__15372,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__15372,(4),null);
var arity = cljs.core.nth.call(null,vec__15372,(5),null);
...
var protocol_part = (cljs.core.truth_((function (){var and__7607__auto__ = protocol_ns;
if(cljs.core.truth_(and__7607__auto__)){
return cljs.core.not.call(null,(function (){var and__7607__auto____$1 = silence_common_protocols_QMARK_;
...
return [cljs.core.str((function (){var or__7619__auto__ = protocol_part;
if(cljs.core.truth_(or__7619__auto__)){
return or__7619__auto__;
} else {
return fn_part;
...
var o__12849__auto__ = f;
return goog.object.get(o__12849__auto__,"getBasis").call(o__12849__auto__);
});
/**
...
if(cljs.core.truth_((function (){var and__7607__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__7607__auto__)){
...
}catch (e15377){var e__12877__auto__ = e15377;
...
var G__15378 = goog.object.get(obj,cljs.core.first.call(null,path));
var G__15379 = cljs.core.rest.call(null,path);
obj = G__15378;
path = G__15379;
continue;
} else {
...
var partition_bits = (function (){var or__7619__auto__ = goog.object.get(obj,partition_key);
if(cljs.core.truth_(or__7619__auto__)){
return or__7619__auto__;
} else {
return (0);
...
return (function (accum,p__15384){
var vec__15385 = p__15384;
var bit = cljs.core.nth.call(null,vec__15385,(0),null);
var protocol = cljs.core.nth.call(null,vec__15385,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__15388){
var vec__15392 = p__15388;
var ns = cljs.core.nth.call(null,vec__15392,(0),null);
var name = cljs.core.nth.call(null,vec__15392,(1),null);
var selector = cljs.core.nth.call(null,vec__15392,(2),null);
...
return (function (p__15400){
var vec__15401 = p__15400;
var munged_name = cljs.core.nth.call(null,vec__15401,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__15401,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__15401,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__15395_SHARP_){
return goog.object.get(obj,cljs.core.first.call(null,p1__15395_SHARP_));
});})(name,sorted_matches,vec__15401,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
