...
var file = cljs.core.get.call(null,map__15195__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__15195__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__15195__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e15194){var _e = e15194;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__6745__auto___15206 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__6745__auto___15206)){
var seen_errors_15207 = temp__6745__auto___15206;
if(cljs.core.truth_(seen_errors_15207.has(self))){
} else {
seen_errors_15207.add(self);

var temp__6747__auto___15208 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__6747__auto___15208)){
var sense_15209 = temp__6747__auto___15208;
self.message = [cljs.core.str(self.message),cljs.core.str(", a sanity hint:\n"),cljs.core.str(sense_15209)].join('');
} else {
}
}
} else {
