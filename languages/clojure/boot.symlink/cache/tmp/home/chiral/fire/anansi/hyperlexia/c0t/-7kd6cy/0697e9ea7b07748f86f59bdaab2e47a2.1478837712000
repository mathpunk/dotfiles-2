...
var len__8835__auto___13881 = arguments.length;
var i__8836__auto___13882 = (0);
while(true){
if((i__8836__auto___13882 < len__8835__auto___13881)){
args__8842__auto__.push((arguments[i__8836__auto___13882]));

var G__13883 = (i__8836__auto___13882 + (1));
i__8836__auto___13882 = G__13883;
continue;
} else {
}
break;
...
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__8843__auto__);
});
...
devtools.formatters.state.update_current_state_BANG_.cljs$lang$applyTo = (function (seq13876){
var G__13877 = cljs.core.first.call(null,seq13876);
var seq13876__$1 = cljs.core.next.call(null,seq13876);
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__13877,seq13876__$1);
});
...
return (p1__13887_SHARP_ === object);
});})(history))
,history);
});
